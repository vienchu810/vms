  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeInOutBack: function (t, e, n, i, o, a) {
      return (
        void 0 == a && (a = 1.70158),
        (e /= o / 2) < 1
          ? (i / 2) * (e * e * ((1 + (a *= 1.525)) * e - a)) + n
          : (i / 2) * ((e -= 2) * e * ((1 + (a *= 1.525)) * e + a) + 2) + n
      );
    },
          ...
          (n.isWindow = function (t) {
            ...
            (n.each = function (t, n, i) {
              var o = 0,
                ...
                r = e(t);
              if (i) {
                if (r) for (; a > o && n.apply(t[o], i) !== !1; o++);
                else for (o in t) if (n.apply(t[o], i) === !1) break;
              } else if (r) for (; a > o && n.call(t[o], o, t[o]) !== !1; o++);
              else for (o in t) if (n.call(t[o], o, t[o]) === !1) break;
              return t;
            }),
                ...
                if (null != (a = arguments[l]))
                  for (o in a)
                    (t = s[o]),
                      (i = a[o]),
                      s !== i &&
                        (u && i && (n.isPlainObject(i) || (e = n.isArray(i)))
                          ? (e
                              ? ((e = !1), (r = t && n.isArray(t) ? t : []))
                              : (r = t && n.isPlainObject(t) ? t : {}),
                            (s[o] = n.extend(u, r, i)))
                          : void 0 !== i && (s[o] = i));
              return s;
            }),
      ...
      (function (t) {
        ...
        return (function (t, e, n, i) {
          ...
          function l(t, n, i, o) {
            ...
            function d() {
              for (var e = 0; b > e; ++e) C[e] = l(e * x, t, i);
            }
            function h(e, n, o) {
              var a,
                r,
            ...
            function p(e) {
              for (var n = 0, o = 1, a = b - 1; o != a && C[o] <= e; ++o)
                n += x;
              --o;
              var r = (e - C[o]) / (C[o + 1] - C[o]),
                s = n + r * x,
                l = c(s, t, i);
              return l >= g ? u(e, s) : 0 == l ? s : h(e, n, n + x);
            }
            function f() {
              (S = !0), (t != n || i != o) && d();
            }
                    ...
                    if (r(S)) {
                      ...
                      for (var I in k)
                        if ("element" !== I) {
                          var A,
                            P = k[I],
                            D = m.isString(P.easing)
                              ? b.Easings[P.easing]
                              : P.easing;
                          if (1 === v) A = P.endValue;
                          else {
                            var _ = P.endValue - P.startValue;
                            if (
                              ((A = P.startValue + _ * D(v, c, _)),
                              !f && A === P.currentValue)
                            )
                              continue;
                          }
                          if (((P.currentValue = A), "tween" === I)) g = A;
                          else {
                            if (w.Hooks.registered[I]) {
                              var E = w.Hooks.getRoot(I),
                                O = r(S).rootPropertyValueCache[E];
                            ...
                            w.Hooks.registered[I] &&
                              (r(S).rootPropertyValueCache[E] = w.Normalizations
                                .registered[E]
                                ? w.Normalizations.registered[E](
                                    "extract",
                                    null,
                                    L[1]
                                  )
                      ...
                      c.mobileHA &&
                        r(S).transformCache.translate3d === i &&
                        ((r(S).transformCache.translate3d = "(0px, 0px, 0px)"),
                        (T = !0)),
                        T && w.flushTransformCache(S);
                    }
                  }
                  c.display !== i &&
                    "none" !== c.display &&
            ...
            for (
              ...
              if (
                (e ||
                  a.loop ||
                  ("none" === a.display &&
                    w.setPropertyValue(d, "display", a.display),
                  "hidden" === a.visibility &&
                    w.setPropertyValue(d, "visibility", a.visibility)),
                a.loop !== !0 &&
                  (h.queue(d)[1] === i ||
          ...
          var w = (b.CSS = {
                ...
                if (p)
                  for (n in w.Hooks.templates) {
                    ...
                    "Color" === o[0] &&
                      (o.push(o.shift()),
                      a.push(a.shift()),
                      (w.Hooks.templates[n] = [o.join(" "), a.join(" ")]));
                  }
                for (n in w.Hooks.templates) {
                  (i = w.Hooks.templates[n]), (o = i[0].split(" "));
                  for (var t in o) {
                    ...
                    w.Normalizations.registered[e] = function (t, n, o) {
                      switch (t) {
                        case "name":
                          return "transform";
                        case "extract":
                          return r(n) === i || r(n).transformCache[e] === i
                            ? /^scale/i.test(e)
                              ? 1
                              : 0
                            : r(n).transformCache[e].replace(/[()]/g, "");
                        case "inject":
                          var a = !1;
                          ...
                          return (
                            a || (r(n).transformCache[e] = "(" + o + ")"),
                            r(n).transformCache[e]
                          );
                      }
                    };
                  })();
            ...
            Names: {
              ...
              SVGAttribute: function (t) {
                ...
                return (
                  (p || (b.State.isAndroid && !b.State.isChrome)) &&
                    (e += "|transform"),
            ...
            getPropertyValue: function (t, n, o, a) {
              function s(t, n) {
                ...
                if (8 >= p) l = h.css(t, n);
                  ...
                  (f =
                    ...
                    (l =
                      9 === p && "filter" === n ? f.getPropertyValue(n) : f[n]),
              ...
              if (w.Hooks.registered[n]) {
                ...
                (d = w.Normalizations.registered[n]("name", t)),
                  "transform" !== d &&
                    ((f = s(t, w.Names.prefixCheck(d)[0])),
                    w.Values.isCSSNullValue(f) &&
                      w.Hooks.templates[n] &&
                      (f = w.Hooks.templates[n][1])),
                  (l = w.Normalizations.registered[n]("extract", t, f));
              }
              if (!/^[\d-]/.test(l))
            ...
            setPropertyValue: function (t, n, i, o, a) {
              ...
              if ("scroll" === n)
                a.container
                  ...
                  : "Left" === a.direction
                  ? e.scrollTo(i, a.alternateValue)
                  : e.scrollTo(a.alternateValue, i);
              else if (
                ...
                if (
                  ...
                  r(t) && r(t).isSVG && w.Names.SVGAttribute(n)
                    ? t.setAttribute(n, i)
                    : (t.style[s] = i);
          ...
          var k = function () {
              ...
              function t(t) {
                    ...
                    m.isArray(t)
                      ? ((n = t[0]),
                        ...
                        w.RegEx.isHex.test(t[1])
                          ? (r = t[1])
                          : ((m.isString(t[1]) && !w.RegEx.isHex.test(t[1])) ||
                              m.isArray(t[1])) &&
                            ((o = e ? t[1] : c(t[1], s.duration)),
                            t[2] !== i && (r = t[2])))
                      : (n = t),
                    e || (o = o || s.easing),
                    m.isFunction(n) && (n = n.call(a, S, C)),
                    m.isFunction(r) && (r = r.call(a, S, C)),
                    [n || 0, o, r]
                  );
                }
                function p(t, e) {
                ...
                if ("scroll" === A) {
                  ...
                  s.container
                    ? m.isWrapped(s.container) || m.isNode(s.container)
                      ? ((s.container = s.container[0] || s.container),
                        (v = s.container["scroll" + T]),
                        (k = v + h(a).position()[T.toLowerCase()] + M))
                      : (s.container = null)
                    : ((v =
                        b.State.scrollAnchor[b.State["scrollProperty" + T]]),
                      (x =
                        b.State.scrollAnchor[
                          b.State[
                  ...
                  "none" === r(a).opts.display && (r(a).opts.display = "auto"),
                    ...
                    (s = h.extend({}, r(a).opts, s));
                  var P = h.extend(!0, {}, r(a).tweensContainer);
                  for (var D in P)
                    if ("element" !== D) {
                      var _ = P[D].startValue;
                      (P[D].startValue = P[D].currentValue = P[D].endValue),
                        (P[D].endValue = _),
                        m.isEmptyObject(y) || (P[D].easing = s.easing),
                        b.debug &&
                          console.log(
                  ...
                  r(a).tweensContainer &&
                    r(a).isAnimating === !0 &&
                    (P = r(a).tweensContainer),
                    h.each(g, function (t, e) {
                      if (
                        RegExp("^" + w.Lists.colors.join("$|^") + "$").test(t)
                      ) {
                        var n = d(e, !0),
                          o = n[0],
                          a = n[1],
                  ...
                  for (var E in g) {
                    ...
                    if (
                      ...
                      ((s.display !== i &&
                        ...
                        0 !== R &&
                        (V = 0),
                        s._cacheValues && P && P[E]
                          ? (V === i && (V = P[E].endValue + P[E].unitType),
                            (N = r(a).rootPropertyValueCache[z]))
                          : w.Hooks.registered[E]
                          ? V === i
                            ? ((N = w.getPropertyValue(a, z)),
                              (V = w.getPropertyValue(a, E, N)))
                            : (N = w.Hooks.templates[z][1])
                          : V === i && (V = w.getPropertyValue(a, E));
                      var H,
                        B,
                        Y,
                        j = !1;
                ...
                l.element &&
                  ...
                  (r(a).isAnimating = !0),
                  S === C - 1
                    ? (b.State.calls.push([F, f, s, null, I.resolver]),
                      b.State.isTicking === !1 &&
              ...
              b.mock !== !1 &&
                ...
                s.queue === !1
                  ? s.delay
                    ...
                    : t()
                  : h.queue(a, s.queue, function (e, n) {
                      return n === !0
                        ? (I.promise && I.resolver(f), !0)
                        : ((b.velocityQueueEntryFlag = !0), void t(e));
                    }),
                ("" !== s.queue && "fx" !== s.queue) ||
                  "inprogress" === h.queue(a)[0] ||
                  h.dequeue(a);
            }
            var s,
              l,
            ...
            if (
              ...
              if (!/^(stop|finish)$/i.test(g) && !h.isPlainObject(y)) {
                var T = p + 1;
                y = {};
                for (var M = T; M < arguments.length; M++)
                  m.isArray(arguments[M]) ||
                  (!/^(fast|normal|slow)$/i.test(arguments[M]) &&
                    !/^\d/.test(arguments[M]))
                    ? m.isString(arguments[M]) || m.isArray(arguments[M])
                      ? (y.easing = arguments[M])
                      : m.isFunction(arguments[M]) &&
                        (y.complete = arguments[M])
                    : (y.duration = arguments[M]);
              }
              var I = { promise: null, resolver: null, rejecter: null };
              s &&
                b.Promise &&
                (I.promise = new b.Promise(function (t, e) {
              ...
              switch (g) {
                ...
                case "stop":
                  ...
                  var P = [];
                  return (
                    h.each(b.State.calls, function (t, e) {
                      e &&
                        h.each(e[1], function (n, o) {
                          ...
                          return (
                            (a !== !0 &&
                              e[2].queue !== a &&
                              (y !== i || e[2].queue !== !1)) ||
                            void h.each(f, function (n, i) {
                              i === o &&
                                ((y === !0 || m.isString(y)) &&
                                  (h.each(
                                    h.queue(i, m.isString(y) ? y : ""),
                                    function (t, e) {
                  ...
                  if (!h.isPlainObject(g) || m.isEmptyObject(g)) {
                    if (m.isString(g) && b.Redirects[g]) {
                      ...
                      return (
                        ...
                        h.each(f, function (t, e) {
                          parseFloat(D.stagger)
                            ? (D.delay = E + parseFloat(D.stagger) * t)
                            : m.isFunction(D.stagger) &&
                              (D.delay = E + D.stagger.call(e, t, C)),
                            D.drag &&
                              ((D.duration =
                                parseFloat(_) ||
                    ...
                    return (
                      I.promise ? I.rejecter(new Error(O)) : console.log(O), t()
                    );
                  }
                  A = "start";
              }
              ...
              var R,
                D = h.extend({}, b.defaults, y);
              if (((D.loop = parseInt(D.loop)), (R = 2 * D.loop - 1), D.loop))
                for (var W = 0; R > W; W++) {
                  var V = { delay: D.delay, progress: D.progress };
                  W === R - 1 &&
                    ((V.display = D.display),
                    (V.visibility = D.visibility),
                    (V.complete = D.complete)),
                    k(f, "reverse", V);
                }
              return t();
            }
          ...
          return (
            ...
            (t.Velocity = b),
            t !== e &&
              ((t.fn.velocity = k), (t.fn.velocity.defaults = b.defaults)),
            ...
            function i(t) {
              if (t) {
                ...
                if (i) {
                  ...
                  for (var o = 0; o < e.length; o++) e[o] = parseInt(i[o + 1]);
                  n = parseFloat(i[4]);
                } else if (
                  (i = t.match(
                    /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/
                ...
                for (var o = 0; o < e.length; o++) e[o] = y(e[o], 0, 255);
            ...
            function o(t) {
              if (t) {
                ...
                if (e) {
                  ...
                  return [
                    y(parseInt(e[1]), 0, 360),
                    y(parseFloat(e[2]), 0, 100),
                    y(parseFloat(e[3]), 0, 100),
                    y(isNaN(n) ? 1 : n, 0, 1),
                  ];
                }
              }
            ...
            (a.prototype = {
              ...
              (a.prototype.setValues = function (t, e) {
                ...
                for (n = 0; n < t.length; n++)
                  (c = Math.max(0, Math.min(r[t][n], o[t][n]))),
                    (o[t][n] = Math.round(c));
                for (var u in a) u !== t && (o[u] = i[t][u](o[t]));
                return !0;
              }),
          ...
          function (t, e, n) {
            ...
            function c(t) {
              ...
              return (
                ...
                [
                  100 * (0.4124 * e + 0.3576 * n + 0.1805 * i),
            ...
            function L(t) {
              var e,
                ...
                r = t[2] / 100;
              return (
                (e = 3.2406 * o + a * -1.5372 + r * -0.4986),
                (n = o * -0.9689 + 1.8758 * a + 0.0415 * r),
                (i = 0.0557 * o + a * -0.204 + 1.057 * r),
                (e =
                  e > 0.0031308
            ...
            function W(t) {
              ...
              return (
                ...
                (i =
                  i / 108.883 <= 0.008859
                    ? (i = (108.883 * (o - s / 200 - 16 / 116)) / 7.787)
            ...
            var Z = {
              ...
              G = {};
            for (var K in Z) G[JSON.stringify(Z[K])] = K;
          },
          {},
        ],
        5: [
        ...
        7: [
          function (t, e, n) {
            ...
            t(26)(i),
              ...
              t(14)(i);
            var o = [];
            o.push(t(41)(i), t(42)(i), t(43)(i)),
              i.plugins.register(o),
              (e.exports = i),
                ...
                (t.controllers.bar = t.DatasetController.extend({
                  ...
                  update: function (t) {
                    var e,
                      ...
                      o = i.getMeta().data;
                    for (
                      i._ruler = i.getRuler(), e = 0, n = o.length;
                      e < n;
                      ++e
                    )
                  ...
                  updateElement: function (t, n, i) {
                    var o = this,
                      ...
                      s = o.getDataset(),
                      l = t.custom || {},
                      c = a.options.elements.rectangle;
                    (t._xScale = o.getScaleForId(r.xAxisID)),
                      (t._yScale = o.getScaleForId(r.yAxisID)),
                      (t._datasetIndex = o.index),
                      (t._index = n),
                      (t._model = {
                        datasetLabel: s.label,
                        label: a.data.labels[n],
                  ...
                  updateElementGeometry: function (t, e, n) {
                    var i = this,
                      ...
                      u = i.calculateBarIndexPixels(i.index, e, l);
                    (o.horizontal = s),
                      (o.base = n ? r : c.base),
                      (o.x = s ? (n ? r : c.head) : u.center),
                      (o.y = s ? u.center : n ? r : c.head),
                  ...
                  getStackCount: function (t) {
                    ...
                    for (e = 0; e < s; ++e)
                      (n = o.getDatasetMeta(e)),
                        n.bar &&
                          o.isDatasetVisible(e) &&
                          (r === !1 ||
                            (r === !0 && l.indexOf(n.stack) === -1) ||
                            (void 0 === r &&
                              (void 0 === n.stack ||
                                l.indexOf(n.stack) === -1))) &&
                          l.push(n.stack);
                  ...
                  getRuler: function () {
                    ...
                    return (
                      (c = Math.min(
                        e.getValueOrDefault(i.barThickness, c),
                  ...
                  calculateBarValuePixels: function (t, e) {
                    ...
                    if (f || (void 0 === f && void 0 !== m))
                      for (n = 0; n < t; ++n)
                        (i = c.getDatasetMeta(n)),
                          i.bar &&
                            i.stack === m &&
                            i.controller.getValueScaleId() === d.id &&
                            c.isDatasetVisible(n) &&
                            ((o = Number(h[n].data[e])),
                            ((p < 0 && o < 0) || (p >= 0 && o > 0)) &&
                              (g += o));
                    return (
                      (a = d.getPixelForValue(g)),
                      (r = d.getPixelForValue(g + p)),
                      (s = (r - a) / 2),
                      { size: s, base: a, head: r, center: r + s / 2 }
                    );
                  },
                  calculateBarIndexPixels: function (t, e, n) {
                    ...
                    return (
                      (s -= a ? n.tickSize / 2 : 0),
                      (s += n.fullBarSize * r),
                      (s += n.categorySpacing / 2),
                      (s += n.barSpacing / 2),
                      { size: l, base: s, head: s + l, center: s + l / 2 }
                    );
                  },
                  draw: function () {
                    var t,
                  ...
                  setHoverStyle: function (t) {
                    var n = this.chart.data.datasets[t._datasetIndex],
                      ...
                      o = t.custom || {},
                      a = t._model;
                    (a.backgroundColor = o.hoverBackgroundColor
                      ? o.hoverBackgroundColor
                      : e.getValueAtIndexOrDefault(
                          n.hoverBackgroundColor,
                          i,
                          e.getHoverColor(a.backgroundColor)
                        )),
                      (a.borderColor = o.hoverBorderColor
                        ? o.hoverBorderColor
                        : e.getValueAtIndexOrDefault(
                            n.hoverBorderColor,
                            i,
                            e.getHoverColor(a.borderColor)
                          )),
                      (a.borderWidth = o.hoverBorderWidth
                        ? o.hoverBorderWidth
                        : e.getValueAtIndexOrDefault(
                            n.hoverBorderWidth,
                            i,
                ...
                (t.controllers.bubble = t.DatasetController.extend({
                  ...
                  updateElement: function (n, i, o) {
                    ...
                    e.extend(n, {
                      ...
                      _model: {
                        ...
                        y: o ? l.getBasePixel() : l.getPixelForValue(d, i, p),
                        radius: o ? 0 : c.radius ? c.radius : a.getRadius(d),
                    ...
                    var f = n._model;
                    (f.skip = c.skip ? c.skip : isNaN(f.x) || isNaN(f.y)),
                      n.pivot();
                  },
                  ...
                  setHoverStyle: function (n) {
                    ...
                    var o = i.chart.data.datasets[n._datasetIndex],
                      a = n._index,
                      r = n.custom || {};
                    n._model.radius = r.hoverRadius
                      ? r.hoverRadius
                      : e.getValueAtIndexOrDefault(
                          o.hoverRadius,
                          a,
                          i.chart.options.elements.point.hoverRadius
                        ) + i.getRadius(o.data[a]);
                  },
                  removeHoverStyle: function (e) {
                    ...
                    var i =
                        n.chart.data.datasets[e._datasetIndex].data[e._index],
                      o = e.custom || {};
                        ...
                        ? n.labels.map(function (i, o) {
                            ...
                            return {
                              ...
                              fillStyle: l.backgroundColor
                                ? l.backgroundColor
                                : c(r.backgroundColor, o, u.backgroundColor),
                              strokeStyle: l.borderColor
                                ? l.borderColor
                                : c(r.borderColor, o, u.borderColor),
                              lineWidth: l.borderWidth
                                ? l.borderWidth
                                : c(r.borderWidth, o, u.borderWidth),
                              hidden: isNaN(r.data[o]) || a.data[o].hidden,
                              index: o,
                            };
                          })
                        : [];
                  ...
                  callbacks: {
                    ...
                    label: function (t, n) {
                      var i = n.labels[t.index],
                        o = ": " + n.datasets[t.datasetIndex].data[t.index];
                      return (
                        e.isArray(i)
                          ? ((i = i.slice()), (i[0] += o))
                          : (i += o),
                ...
                (t.controllers.doughnut = t.controllers.pie =
                  t.DatasetController.extend({
                    ...
                    update: function (t) {
                      ...
                      (i.borderWidth = n.getMaxBorderWidth(d.data)),
                    ...
                    updateElement: function (t, n, i) {
                      var o = this,
                        ...
                        f =
                          i && l.animateRotate
                            ...
                            : t.hidden
                            ? 0
                            : o.calculateCircumference(p.data[n]) *
                      ...
                      e.extend(t, {
                        ...
                        _model: {
                          ...
                          outerRadius: g,
                          innerRadius: m,
                          label: v(p.label, n, a.data.labels[n]),
                        },
                      });
                      var y = t._model;
                      this.removeHoverStyle(t),
                        (i && l.animateRotate) ||
                          ((y.startAngle =
                            0 === n
                              ? s.rotation
                              : o.getMeta().data[n - 1]._model.endAngle),
                    ...
                    getMaxBorderWidth: function (t) {
                      for (
                        var e, n, i = 0, o = this.index, a = t.length, r = 0;
                        r < a;
                        r++
                      )
                ...
                (t.controllers.line = t.DatasetController.extend({
                    ...
                    for (
                      f &&
                        ...
                        (l._model = {
                          ...
                          tension: a.tension
                            ? a.tension
                            : n.getValueOrDefault(p.lineTension, d.tension),
                          ...
                          steppedLine: a.steppedLine
                            ? a.steppedLine
                            : n.getValueOrDefault(p.steppedLine, d.stepped),
                  ...
                  getPointBackgroundColor: function (t, e) {
                    ...
                    return (
                      a.backgroundColor
                        ...
                        : o.backgroundColor && (i = o.backgroundColor),
                      i
                    );
                  },
                    ...
                    return (
                      isNaN(a.borderWidth)
                        ? isNaN(o.pointBorderWidth)
                          ? isNaN(o.borderWidth) || (i = o.borderWidth)
                          : (i = n.getValueAtIndexOrDefault(
                              o.pointBorderWidth,
                              e,
                              i
                  ...
                  calculatePointY: function (t, e, n) {
                    ...
                    if (c.options.stacked) {
                      ...
                      return p < 0
                        ? c.getPixelForValue(d + p)
                        : c.getPixelForValue(u + p);
                    }
                  ...
                  updateBezierControlPoints: function () {
                    ...
                    if (
                      ...
                      n.splineCurveMonotone(u);
                    else
                      for (e = 0, i = u.length; e < i; ++e)
                        (o = u[e]),
                          (a = o._model),
                          (r = n.splineCurve(
                            n.previousItem(u, e)._model,
                            a,
                            n.nextItem(u, e)._model,
                            l.dataset._model.tension
                          )),
                          (a.controlPointPreviousX = r.previous.x),
                          (a.controlPointPreviousY = r.previous.y),
                          (a.controlPointNextX = r.next.x),
                          (a.controlPointNextY = r.next.y);
                    if (s.chart.options.elements.line.capBezierPoints)
                      for (e = 0, i = u.length; e < i; ++e)
                        (a = u[e]._model),
                          (a.controlPointPreviousX = t(
                            a.controlPointPreviousX,
                            c.left,
                            c.right
                          )),
                          (a.controlPointPreviousY = t(
                            a.controlPointPreviousY,
                            c.top,
                            c.bottom
                          )),
                          (a.controlPointNextX = t(
                            a.controlPointNextX,
                            c.left,
                            c.right
                          )),
                          (a.controlPointNextY = t(
                            a.controlPointNextY,
                            c.top,
                            c.bottom
                          ));
                  ...
                  draw: function () {
                    ...
                    for (
                      t.canvasHelpers.clipArea(i.ctx, r),
                        e(n.getDataset(), i.options) && o.dataset.draw(),
                    ...
                    (a.radius =
                      ...
                      (a.backgroundColor =
                        ...
                        n.getValueAtIndexOrDefault(
                          ...
                          i,
                          n.getHoverColor(a.backgroundColor)
                        )),
                      (a.borderColor =
                        o.hoverBorderColor ||
                        n.getValueAtIndexOrDefault(
                  ...
                  removeHoverStyle: function (t) {
                    ...
                    void 0 !== i.radius &&
                      ...
                      (r.backgroundColor = e.getPointBackgroundColor(t, o)),
                      (r.borderColor = e.getPointBorderColor(t, o)),
                      (r.borderWidth = e.getPointBorderWidth(t, o));
                  },
                }));
            };
          },
                  ...
                  update: function (t) {
                    ...
                    (i.outerRadius = Math.max((l - s.borderWidth / 2) / 2, 0)),
                      ...
                      (i.radiusLength =
                        ...
                        i.getVisibleDatasetCount()),
                      (n.outerRadius =
                        i.outerRadius - i.radiusLength * n.index),
                  ...
                  updateElement: function (t, n, i) {
                    for (
                      var o = this,
                        ...
                        d = a.data.labels,
                        h = o.calculateCircumference(r.data[n]),
                        p = c.xCenter,
                        f = c.yCenter,
                        m = 0,
                        g = o.getMeta(),
                    ...
                    var y = s.startAngle,
                      b = t.hidden
                        ? 0
                        : c.getDistanceFromCenterForValue(r.data[n]),
                      x = y + h * m,
                      w = x + (t.hidden ? 0 : h),
                      k = l.animateScale
                        ? 0
                ...
                (t.controllers.radar = t.DatasetController.extend({
                    ...
                    void 0 !== s.tension &&
                      ...
                      e.extend(i.dataset, {
                        ...
                        _model: {
                          tension: r.tension
                            ? r.tension
                            : e.getValueOrDefault(s.lineTension, l.tension),
                  ...
                  updateElement: function (t, n, i) {
                    var o = this,
                      ...
                      c = s.getPointPositionForValue(n, r.data[n]);
                    void 0 !== r.radius &&
                      ...
                      e.extend(t, {
                        ...
                        _model: {
                          ...
                          tension: a.tension
                            ...
                            : e.getValueOrDefault(
                                r.lineTension,
                                o.chart.options.elements.line.tension
                              ),
                          radius: a.radius
                            ? a.radius
                            : e.getValueAtIndexOrDefault(
                  ...
                  updateBezierControlPoints: function () {
                    ...
                    e.each(n.data, function (i, o) {
                      var a = i._model,
                        r = e.splineCurve(
                          e.previousItem(n.data, o, !0)._model,
                          a,
                          e.nextItem(n.data, o, !0)._model,
                          a.tension
                        );
                  ...
                  removeHoverStyle: function (t) {
                    ...
                    (a.radius = i.radius
                      ? i.radius
                      : e.getValueAtIndexOrDefault(n.pointRadius, o, r.radius)),
                ...
                (t.animationService = {
                  ...
                  addAnimation: function (t, e, n, i) {
                    var o,
                      ...
                      r = this.animations;
                    for (
                      e.chart = t, i || (t.animating = !0), o = 0, a = r.length;
                      o < a;
                      ++o
                    )
          ...
          function (t, e, n) {
            ...
            e.exports = function (t) {
              ...
              (e.drawPoint = function (e, n, i, o, a) {
                ...
                if (
                  "object" == typeof n &&
                  ("[object HTMLImageElement]" === (r = n.toString()) ||
                  ...
                  switch (n) {
                    ...
                    case "triangle":
                      e.beginPath(),
                        (s = (3 * i) / Math.sqrt(3)),
                        (u = (s * Math.sqrt(3)) / 2),
                        e.moveTo(o - s / 2, a + u / 3),
                        e.lineTo(o + s / 2, a + u / 3),
                        e.lineTo(o, a - (2 * u) / 3),
                        e.closePath(),
                        e.fill();
                      break;
                    case "rect":
                      (d = (1 / Math.SQRT2) * i),
                        e.beginPath(),
                        e.fillRect(o - d, a - d, 2 * d, 2 * d),
                        e.strokeRect(o - d, a - d, 2 * d, 2 * d);
                      break;
                    case "rectRounded":
                      var h = i / Math.SQRT2,
                        p = o - h,
                        f = a - h,
                        m = Math.SQRT2 * i;
                      t.helpers.drawRoundedRectangle(e, p, f, m, m, i / 2),
                        e.fill();
                      break;
                    case "rectRot":
                      (d = (1 / Math.SQRT2) * i),
                ...
                o.extend(t.prototype, {
                  ...
                  resize: function (t) {
                    var e = this,
                      ...
                      l = Math.floor(r ? s / r : o.getMaximumHeight(i));
                    if (
                    ...
                    if (
                      (o.each(
                        ...
                        function (o, a) {
                          ...
                          if (
                            (r.type || (r.type = o.type || e.config.type),
                            n.push(r.type),
                            r.controller)
                          )
                  ...
                  update: function (t, e) {
                    var i = this;
                    if ((n(i), a.notify(i, "beforeUpdate") !== !1)) {
                  ...
                  updateDataset: function (t) {
                    var e = this,
                      ...
                      i = { meta: n, index: t };
                    a.notify(e, "beforeDatasetUpdate", [i]) !== !1 &&
                      (n.controller.update(),
                      a.notify(e, "afterDatasetUpdate", [i]));
                  },
                  render: function (e, n) {
                    var i = this;
                    if (a.notify(i, "beforeRender") !== !1) {
                      var r = i.options.animation,
                        s = function (t) {
                          a.notify(i, "afterRender"),
                            o.callback(r && r.onComplete, [t], i);
                        };
                      if (
                        r &&
                        ((void 0 !== e && 0 !== e) ||
                          (void 0 === e && 0 !== r.duration))
                      ) {
                  ...
                  drawDatasets: function (t) {
                    var e = this;
                    if (a.notify(e, "beforeDatasetsDraw", [t]) !== !1) {
                      for (
                  ...
                  drawDataset: function (t, e) {
                    var n = this,
                      ...
                      o = { meta: i, index: t, easingValue: e };
                    a.notify(n, "beforeDatasetDraw", [o]) !== !1 &&
                      (i.controller.draw(e),
                      a.notify(n, "afterDatasetDraw", [o]));
                  },
                  ...
                  destroy: function () {
                    var e,
                      ...
                      l = s.canvas;
                    for (
                      s.stop(), n = 0, i = s.data.datasets.length;
                      n < i;
                      ++n
                    )
                  ...
                  handleEvent: function (t) {
                    ...
                    return (
                      ...
                      (a = !o.arrayEquals(e.active, e.lastActive)),
                ...
                i.extend(t.DatasetController.prototype, {
                  ...
                  buildOrUpdateElements: function () {
                    var t = this,
                      ...
                      o = i.data || (i.data = []);
                    t._data !== o &&
                      (t._data && n(t._data, t), e(o, t), (t._data = o)),
                      t.resyncElements();
                  },
                  update: i.noop,
                  transition: function (t) {
                  ...
                  removeHoverStyle: function (t, e) {
                    ...
                    (s.backgroundColor = a.backgroundColor
                      ? a.backgroundColor
                      : r(n.backgroundColor, o, e.backgroundColor)),
                      (s.borderColor = a.borderColor
                        ? a.borderColor
                        : r(n.borderColor, o, e.borderColor)),
                      (s.borderWidth = a.borderWidth
                        ? a.borderWidth
                        : r(n.borderWidth, o, e.borderWidth));
                  },
                  setHoverStyle: function (t) {
                    var e = this.chart.data.datasets[t._datasetIndex],
                      n = t._index,
                    ...
                    (s.backgroundColor = o.hoverBackgroundColor
                      ? o.hoverBackgroundColor
                      : a(e.hoverBackgroundColor, n, r(s.backgroundColor))),
                      (s.borderColor = o.hoverBorderColor
                        ? o.hoverBorderColor
                        : a(e.hoverBorderColor, n, r(s.borderColor))),
                      (s.borderWidth = o.hoverBorderWidth
                        ? o.hoverBorderWidth
                        : a(e.hoverBorderWidth, n, s.borderWidth));
                  },
              ...
              (t.elements = {}),
                ...
                n.extend(t.Element.prototype, {
                  ...
                  pivot: function () {
                    var t = this;
                    return (
                      t._view || (t._view = n.clone(t._model)),
                      (t._start = {}),
                      t
                    );
                  },
                  ...
                  hasValue: function () {
                    return (
                      n.isNumber(this._model.x) && n.isNumber(this._model.y)
                    );
                  },
                }),
          ...
          function (t, e, n) {
            ...
            e.exports = function (t) {
              ...
              function o(t, i, o) {
                ...
                return c || u
                  ? Math.min(c ? e(s, t, o) : d, u ? e(l, r, o) : d)
                  : "none";
              }
              var a = (t.helpers = {});
                      ...
                      "xAxes" === n || "yAxes" === n
                        ? i.hasOwnProperty(n)
                          ? a.each(e, function (e, o) {
                              var r = a.getValueOrDefault(
                                  e.type,
                                  "xAxes" === n ? "category" : "linear"
                                ),
                                s = t.scaleService.getScaleDefaults(r);
                              o >= i[n].length || !i[n][o].type
                                ? i[n].push(a.configMerge(s, e))
                                : e.type && e.type !== i[n][o].type
                                ? (i[n][o] = a.configMerge(i[n][o], s, e))
                                : (i[n][o] = a.configMerge(i[n][o], e));
                            })
                          : ((i[n] = []),
                            a.each(e, function (e) {
                              var o = a.getValueOrDefault(
                                e.type,
                                "xAxes" === n ? "category" : "linear"
                              );
                              i[n].push(
                                a.configMerge(
                                  t.scaleService.getScaleDefaults(o),
                                  e
                                )
                              );
                            }))
                ...
                (a.splineCurveMonotone = function (t) {
                  ...
                  for (e = 0; e < s; ++e)
                    if (((i = r[e]), !i.model.skip)) {
                      if (
                        ((n = e > 0 ? r[e - 1] : null),
                        (o = e < s - 1 ? r[e + 1] : null) && !o.model.skip)
                      ) {
                  ...
                  for (e = 0; e < s; ++e)
                    (i = r[e]),
                      i.model.skip ||
                        ...
                        n &&
                          !n.model.skip &&
                          ((p = (i.model.x - n.model.x) / 3),
                          (i.model.controlPointPreviousX = i.model.x - p),
                          (i.model.controlPointPreviousY =
                            i.model.y - p * i.mK)),
                        o &&
                          !o.model.skip &&
                          ((p = (o.model.x - i.model.x) / 3),
                          (i.model.controlPointNextX = i.model.x + p),
                          (i.model.controlPointNextY = i.model.y + p * i.mK)));
                }),
              ...
              (a.requestAnimFrame = (function () {
                ...
                (a.getRelativePosition = function (t, e) {
                  ...
                  return (
                    (n = Math.round(
                      (((n - s.left - c) / p) * r.width) /
                        e.currentDevicePixelRatio
                    )),
                    (i = Math.round(
                      (((i - s.top - u) / f) * r.height) /
                        e.currentDevicePixelRatio
                    )),
                    { x: n, y: i }
                  );
                ...
                (a.measureText = function (t, e, n, i, o) {
                  var a = e[o];
                  return (
                    a || ((a = e[o] = t.measureText(o).width), n.push(o)),
                    a > i && (i = a),
                    i
                  );
                }),
            ...
            e.exports = function (t) {
              ...
              function n(t, e) {
                ...
                for (i = 0, a = s.length; i < a; ++i)
                  if (t.isDatasetVisible(i))
                    for (
                      n = t.getDatasetMeta(i), o = 0, r = n.data.length;
                      o < r;
                      ++o
                    ) {
                      var l = n.data[o];
              ...
              t.Interaction = {
                modes: {
                  ...
                  label: a,
                  index: a,
                  dataset: function (t, n, a) {
                    var r = e(n, t),
                      s = a.intersect ? i(t, r) : o(t, r, !1);
                    return (
                      s.length > 0 &&
                        (s = t.getDatasetMeta(s[0]._datasetIndex).data),
                      s
                    );
                  },
                  "x-axis": function (t, e) {
                      ...
                      r.length > 1 &&
                        r.sort(function (t, e) {
                          var n = t.getArea(),
                            ...
                            o = n - i;
                          return (
                            0 === o && (o = t._datasetIndex - e._datasetIndex),
                            o
                          );
                        }),
                      r.slice(0, 1)
                  ...
                  x: function (t, i, o) {
                    ...
                    return (
                      n(t, function (t) {
                        t.inXRange(a.x) && r.push(t),
                          t.inRange(a.x, a.y) && (s = !0);
                      }),
                      o.intersect && !s && (r = []),
                      r
                    );
                ...
                update: function (t, o, a) {
                  function r(t) {
                    var e,
                      n = t.isHorizontal();
                    n
                      ? ((e = t.update(t.fullWidth ? w : I, M)),
                        (A -= e.height))
                      : ((e = t.update(T, S)), (I -= e.width)),
                  ...
                  function s(t) {
                    ...
                    if (e)
                      if (t.isHorizontal()) {
                        ...
                        t.update(t.fullWidth ? w : I, k / 2, n);
                  ...
                  function l(t) {
                    var e = i.findNextWhere(P, function (e) {
                      ...
                      n = { left: 0, right: 0, top: R, bottom: W };
                    e && t.update(e.minSize.width, A, n);
                  }
                  function c(t) {
                    t.isHorizontal()
                      ? ((t.left = t.fullWidth ? h : L),
                        (t.right = t.fullWidth ? o - p : L + I),
                        (t.top = Y),
                        (t.bottom = Y + t.height),
                        (Y = t.bottom))
                      : ((t.left = B),
                  ...
                  if (t) {
                    ...
                    i.each(y.concat(b), function (t) {
                      if (t.getPadding) {
                        var e = t.getPadding();
                        (D = Math.max(D, e.left)), (_ = Math.max(_, e.right));
                      }
                    }),
                    ...
                    var V = Math.max(D - L, 0);
                    (L += V), (F += Math.max(_ - F, 0));
                    var z = Math.max(E - R, 0);
                    (R += z), (W += Math.max(O - W, 0));
                    var N = a - R - W,
                      H = o - L - F;
                    (H === I && N === A) ||
                      (i.each(g, function (t) {
            ...
            e.exports = function (t) {
              ...
              function n(e) {
                var n = i.getValueOrDefault,
                  ...
                  s = n(e.fontFamily, o.defaultFontFamily);
                return {
                  size: a,
                  style: r,
                  family: s,
                  font: i.fontString(a, r, s),
                };
              }
              var i = t.helpers;
              (t.defaults.scale = {
                ...
                (t.Scale = t.Element.extend({
                  ...
                  beforeTickToLabelConversion: function () {
                    i.callback(this.options.beforeTickToLabelConversion, [
                      this,
                    ]);
                  },
                  ...
                  beforeCalculateTickRotation: function () {
                    i.callback(this.options.beforeCalculateTickRotation, [
                      this,
                    ]);
                  },
                  calculateTickRotation: function () {
                    ...
                    if (t.options.display && t.isHorizontal())
                      for (
                        ...
                        var d = i.toRadians(r);
                        if (
                          ((s = Math.cos(d)), Math.sin(d) * l > t.maxHeight)
                        ) {
                          r--;
                          break;
                        }
                  ...
                  fit: function () {
                    ...
                    if (
                      ((o.width = u
                        ...
                        ? p
                        : 0),
                      (o.height = u ? (c && l.drawTicks ? p : 0) : t.maxHeight),
                      s.display && c && (u ? (o.height += h) : (o.width += h)),
                      r.display && c)
                    ) {
                      var f = i.longestText(
                          t.ctx,
                      ...
                      if (u) {
                        ...
                        var v = i.toRadians(t.labelRotation),
                          ...
                          b = Math.sin(v),
                          x = b * f + d.size * m + g * m;
                        (o.height = Math.min(t.maxHeight, o.height + x)),
                          (t.ctx.font = d.font);
                        var w = t.ticks[0],
                          k = e(t.ctx, w, d.font),
                        ...
                        0 !== t.labelRotation
                          ? ((t.paddingLeft =
                              "bottom" === a.position ? y * k + 3 : y * g + 3),
                            (t.paddingRight =
                              "bottom" === a.position ? y * g + 3 : y * S + 3))
                          : ((t.paddingLeft = k / 2 + 3),
                            (t.paddingRight = S / 2 + 3));
                      } else
                        r.mirror ? (f = 0) : (f += t.options.ticks.padding),
                          (o.width = Math.min(t.maxWidth, o.width + f)),
                  ...
                  draw: function (e) {
                    ...
                    if (a.display) {
                      ...
                      var g = i.getValueOrDefault(
                        ...
                        k = Math.cos(w),
                        C = o.longestLabelWidth * k;
                      l.fillStyle = g;
                      var S = [];
                      if (m) {
                        if (
                          ((r = !1),
                          (C + u.autoSkipPadding) * o.ticks.length >
                      ...
                      var T = "right" === a.position ? o.left : o.right - y,
                        ...
                        A = "bottom" === a.position ? o.top + y : o.bottom;
                      if (
                        (i.each(o.ticks, function (t, n) {
                          if (void 0 !== t && null !== t) {
                            var s = o.ticks.length === n + 1;
                            if (
                              (!(
                                (r > 1 && n % r > 0) ||
                                (n % r == 0 && n + r >= o.ticks.length)
                              ) ||
                                s) &&
                              void 0 !== t &&
                              null !== t
                              ...
                              var l, h, f, g;
                              n ===
                              (void 0 !== o.zeroLineIndex ? o.zeroLineIndex : 0)
                                ? ((l = d.zeroLineWidth),
                                  (h = d.zeroLineColor),
                                  (f = d.zeroLineBorderDash),
                                  (g = d.zeroLineBorderDashOffset))
                                : ((l = i.getValueAtIndexOrDefault(
                                    d.lineWidth,
                                    n
                                  )),
                                  (h = i.getValueAtIndexOrDefault(d.color, n)),
                              ...
                              if (m) {
                                ...
                                (E =
                                  o.getPixelForTick(n, d.offsetGridLines) +
                                  u.labelOffset),
                                  (v = x = C = D = R),
                                  (b = I),
                                  (k = A),
                                ...
                                u.mirror
                                  ? ((L = V ? "left" : "right"), (W = z))
                                  : ((L = V ? "right" : "left"), (W = y + z)),
                                  (E = V ? o.right - W : o.left + W);
                                var N = o.getPixelForTick(n);
                                (N += i.aliasPixel(l)),
                                  (O = o.getPixelForTick(n, d.offsetGridLines)),
                                  (v = T),
                                  (x = M),
                                  (C = e.left),
                                  (D = e.right),
                        ...
                        if (m)
                          ...
                          (P = E ? o.left + x.size / 2 : o.right - x.size / 2),
                            (D = o.top + (o.bottom - o.top) / 2),
                            (_ = E ? -0.5 * Math.PI : 0.5 * Math.PI);
                        }
                        l.save(),
                          l.translate(P, D),
                          l.rotate(_),
                      ...
                      if (d.drawBorder) {
                        (l.lineWidth = i.getValueAtIndexOrDefault(
                          d.lineWidth,
                          0
                        )),
                          (l.strokeStyle = i.getValueAtIndexOrDefault(
                            d.color,
                            0
                          ));
                        var O = o.left,
                        ...
                        m
                          ? ((F = R = "top" === a.position ? o.bottom : o.top),
                            (F += W),
                            (R += W))
                          : ((O = L = "left" === a.position ? o.right : o.left),
                            (O += W),
                            (L += W)),
                          l.beginPath(),
                          l.moveTo(O, F),
                ...
                generators: {
                  linear: function (t, n) {
                    ...
                    t.min &&
                      ...
                      ((r = t.min), (s = t.max));
                    var l = (s - r) / i;
                    (l = e.almostEquals(l, Math.round(l), i / 1e3)
                      ? Math.round(l)
                      : Math.ceil(l)),
                  ...
                  logarithmic: function (t, n) {
                    ...
                    0 === s
                      ? ((i = Math.floor(e.log10(n.minNotZero))),
                        (o = Math.floor(n.minNotZero / Math.pow(10, i))),
                        a.push(s),
                        (s = o * Math.pow(10, i)))
                      : ((i = Math.floor(e.log10(s))),
            ...
            e.exports = function (t) {
              ...
              function a(t, e) {
                ...
                (i += s * u),
                  ...
                  (i += c ? e.footerMarginTop : 0),
                  (i += c * h),
                  (i += c ? (c - 1) * e.footerSpacing : 0);
                var p = 0,
                  f = function (t) {
                ...
                return (
                  ...
                  l.each(e.beforeBody.concat(e.afterBody), f),
              ...
              function r(t, e) {
                ...
                "center" === r
                  ...
                  s(n.x)
                    ? ((a = "left"), c(n.x) && ((a = "center"), (r = d(n.y))))
                    : l(n.x) &&
                      ((a = "right"), u(n.x) && ((a = "center"), (r = d(n.y))));
                var f = t._options;
                return {
              ...
              function s(t, e, n) {
                ...
                return (
                  ...
                  "top" === c
                    ? (o += u)
                    : (o -= "bottom" === c ? e.height + u : e.height / 2),
                  "center" === c
                    ? "left" === l
                      ? (i += u)
                      : "right" === l && (i -= u)
                ...
                (t.Tooltip = t.Element.extend({
                  ...
                  getTitle: function () {
                    var t = this,
                      ...
                      s = [];
                    return (s = n(s, o)), (s = n(s, a)), (s = n(s, r));
                  },
                  ...
                  getBody: function (t, e) {
                    ...
                    return (
                      l.each(t, function (t) {
                        ...
                        n(r.before, o.beforeLabel.call(i, t, e)),
                          n(r.lines, o.label.call(i, t, e)),
                          n(r.after, o.afterLabel.call(i, t, e)),
                          a.push(r);
                      }),
                      a
                    );
                  ...
                  update: function (e) {
                    ...
                    if (f.length) {
                      p.opacity = 1;
                      var x = [];
                      b = t.Tooltip.positioners[d.position](
                        f,
                        u._eventPosition
                      );
                      var w = [];
                      for (n = 0, c = f.length; n < c; ++n) w.push(i(f[n]));
                      d.filter &&
                        ...
                        (p.title = u.getTitle(w, m)),
                        (p.beforeBody = u.getBeforeBody(w, m)),
                        (p.body = u.getBody(w, m)),
                        (p.afterBody = u.getAfterBody(w, m)),
                        (p.footer = u.getFooter(w, m)),
                        (p.x = Math.round(b.x)),
                        (p.y = Math.round(b.y)),
                        (p.caretPadding = d.caretPadding),
                        (p.labelColors = x),
                        (p.dataPoints = w),
                        (y = a(this, p)),
                        (g = r(this, y)),
                  ...
                  drawTitle: function (t, n, i, o) {
                    ...
                    if (a.length) {
                      ...
                      var r = n.titleFontSize,
                        s = n.titleSpacing;
                      (i.fillStyle = e(n.titleFontColor, o)),
                        (i.font = l.fontString(
                          r,
                          n._titleFontStyle,
                          n._titleFontFamily
                      ...
                      for (c = 0, u = a.length; c < u; ++c)
                        i.fillText(a[c], t.x, t.y),
                          (t.y += r + s),
                          c + 1 === a.length &&
                            (t.y += n.titleMarginBottom - s);
                    }
                  },
                  drawBody: function (t, n, i, o) {
                    ...
                    (u = h ? a + 2 : 0),
                      l.each(s, function (r, s) {
                        l.each(r.before, d),
                          l.each(r.lines, function (r) {
                            h &&
                              ((i.fillStyle = e(n.legendColorBackground, o)),
                  ...
                  drawFooter: function (t, n, i, o) {
                    ...
                    a.length &&
                      ...
                      (i.textBaseline = "top"),
                      (i.fillStyle = e(n.footerFontColor, o)),
                      (i.font = l.fontString(
                        n.footerFontSize,
                        n._footerFontStyle,
                        n._footerFontFamily
                  ...
                  drawBackground: function (t, n, i, o, a) {
                    (i.fillStyle = e(n.backgroundColor, a)),
                      (i.strokeStyle = e(n.borderColor, a)),
                  ...
                  handleEvent: function (t) {
                    ...
                    if (((e._lastActive = e._active), n.enabled || n.custom)) {
                      ...
                      e.update(!0),
                        e.pivot(),
                        (i |= o.x !== e._model.x || o.y !== e._model.y);
                    }
                    return i;
                  },
                })),
              ...
              (n.elements.arc = {
                ...
                (t.elements.Arc = t.Element.extend({
                  ...
                  inRange: function (t, n) {
                    ...
                    if (i) {
                      for (
                        var o = e.getAngleFromPoint(i, { x: t, y: n }),
                          a = o.angle,
                          r = o.distance,
                          s = i.startAngle,
                          l = i.endAngle;
                  ...
                  draw: function () {
                    ...
                    for (
                      r._loop && u.length && u.push(u[0]),
                        ...
                        l.setLineDash &&
                          l.setLineDash(s.borderDash || d.borderDash),
                        l.lineDashOffset =
                        ...
                        l.strokeStyle = s.borderColor || n.defaultColor,
                        l.beginPath(),
                        h = -1,
                        t = 0;
                      t < u.length;
                      ...
                      (i = u[t]),
                        (o = e.previousItem(u, t)),
                        (a = i._view),
                        0 === t
                          ? a.skip || (l.moveTo(a.x, a.y), (h = t))
                          : ((o = h === -1 ? o : u[h]),
                            a.skip ||
                              ((h !== t - 1 && !c) || h === -1
                                ? l.moveTo(a.x, a.y)
                                : e.canvas.lineTo(l, o._view, i._view),
                              (h = t)));
                    l.stroke(), l.restore();
                  },
                }));
                ...
                (t.elements.Point = t.Element.extend({
                  ...
                  draw: function (e) {
                    var n = this._view,
                      ...
                      p = 0;
                    n.skip ||
                      ((s.strokeStyle = n.borderColor || a),
                      (s.lineWidth = i.getValueOrDefault(
                        n.borderWidth,
                        o.elements.point.borderWidth
                      )),
                      (s.fillStyle = n.backgroundColor || a),
                      void 0 !== e &&
                        (r.x < e.left ||
                          1.01 * e.right < r.x ||
                          r.y < e.top ||
                        ...
                        (r.x < e.left
                          ...
                          ? (p = (d - r.y) / (e.top - r.y))
                          : 1.01 * e.bottom < r.y &&
                            (p = (r.y - d) / (r.y - e.bottom)),
                        (p = Math.round(100 * p) / 100),
                        (s.strokeStyle = h(s.strokeStyle).alpha(p).rgbString()),
                        (s.fillStyle = h(s.fillStyle).alpha(p).rgbString())),
                      t.canvasHelpers.drawPoint(s, l, c, u, d));
                  },
                }));
            };
          },
              ...
              (i.elements.rectangle = {
                ...
                (t.elements.Rectangle = t.Element.extend({
                  draw: function () {
                    ...
                    l.beginPath(),
                      (l.fillStyle = c.backgroundColor),
                      (l.strokeStyle = c.borderColor),
                      (l.lineWidth = u);
                    var v = [
                        [e, o],
                        [e, i],
            ...
            e.exports = function (t) {
              ...
              return {
                ...
                removeEventListener: function (t, e, n) {
                  var i = t.canvas;
                  if ("resize" === e) return void s(i.parentNode);
                  var o = n._chartjs || {},
                    a = o.proxies || {},
                    r = a[t.id + "_" + e];
          ...
          function (t, e, n) {
            ...
            e.exports = function (t) {
              function e(t, e, n) {
                ...
                if (
                  ((i = parseFloat(a, 10)), isFinite(i) && Math.floor(i) === i)
                )
                  return (
                    ("-" !== a[0] && "+" !== a[0]) || (i = e + i),
                    !(i === e || i < 0 || i >= n) && i
              ...
              function s(t, e, n, i, o, s) {
                ...
                for (t.beginPath(), l = 0, c = m + !!s; l < c; ++l)
                  (u = l % m),
                    ...
                    (f = a(h)),
                    p && f
                      ? ((b = v.push(d)), (x = y.push(h)))
                      : b &&
                        x &&
                        (g
                          ? (p && v.push(d), f && y.push(h))
                          : (r(t, v, y, b, x),
                            (b = x = 0),
                            (v = []),
                            (y = [])));
              ...
              return {
                id: "filler",
                afterDatasetsUpdate: function (a, r) {
                  var s,
                    l,
                    c,
                    u,
                    ...
                    p = [];
                  for (l = 0; l < d; ++l)
                    (s = a.getDatasetMeta(l)),
                      (c = s.dataset),
                      (u = null),
                      c &&
                        c._model &&
                        c instanceof t.elements.Line &&
                        (u = {
                          visible: a.isDatasetVisible(l),
                          fill: e(c, l, d),
                          chart: a,
                          el: c,
                        }),
              ...
              return (
                (t.defaults.global.legend = {
                  ...
                  onClick: function (t, e) {
                    ...
                    (o.hidden =
                      null === o.hidden ? !i.data.datasets[n].hidden : null),
                      i.update();
                  },
                  onHover: null,
                  labels: {
                ...
                (t.Legend = t.Element.extend({
                  ...
                  fit: function () {
                    ...
                    if (
                      (g
                        ? ((m.width = n.maxWidth), (m.height = r ? 10 : 0))
                        : ((m.width = r ? 10 : 0), (m.height = n.maxHeight)),
                      r)
                    )
                      if (((s.font = p), g)) {
                        var v = (n.lineWidths = [0]),
                          y = n.legendItems.length ? u + a.padding : 0;
                        (s.textAlign = "left"),
                          (s.textBaseline = "top"),
                          i.each(n.legendItems, function (t, i) {
                            var o = e(a, u),
                              r = o + u / 2 + s.measureText(t.text).width;
                            v[v.length - 1] + r + a.padding >= n.width &&
                              ((y += u + a.padding), (v[v.length] = n.left)),
                              (f[i] = { left: 0, top: 0, width: r, height: u }),
                        ...
                        i.each(n.legendItems, function (t, n) {
                          var i = e(a, u),
                            o = i + u / 2 + s.measureText(t.text).width;
                          C + S > m.height &&
                            ((w += k + a.padding), x.push(k), (k = 0), (C = 0)),
                            (k = Math.max(k, o)),
                            (C += S),
                        ...
                        x = function (e, n, i) {
                          if (!(isNaN(y) || y <= 0)) {
                            d.save(),
                              ...
                              (d.lineCap = h(i.lineCap, s.borderCapStyle)),
                              (d.lineDashOffset = h(
                                i.lineDashOffset,
                                s.borderDashOffset
                              )),
                              (d.lineJoin = h(i.lineJoin, s.borderJoinStyle)),
                              (d.lineWidth = h(i.lineWidth, s.borderWidth)),
                              (d.strokeStyle = h(
                                i.strokeStyle,
                                r.defaultColor
                              ));
                            ...
                            if (
                              (d.setLineDash &&
                                d.setLineDash(h(i.lineDash, s.borderDash)),
                              o.labels && o.labels.usePointStyle)
                            ) {
                              ...
                              a || d.strokeRect(e, n, y, f),
                                d.fillRect(e, n, y, f);
                            d.restore();
                          }
                        },
                        w = function (t, e, n, i) {
                          d.fillText(n.text, y + f / 2 + t, e),
                            n.hidden &&
                              (d.beginPath(),
                              (d.lineWidth = 2),
                              d.moveTo(y + f / 2 + t, e + f / 2),
                              d.lineTo(y + f / 2 + t + i, e + f / 2),
                              d.stroke());
                        },
                        k = n.isHorizontal();
                      u = k
                      ...
                      i.each(n.legendItems, function (t, e) {
                        ...
                        k
                          ? r + o >= l &&
                            ((s = u.y += C),
                            u.line++,
                            (r = u.x = n.left + (l - c[u.line]) / 2))
                          : s + C > n.bottom &&
                            ((r = u.x = r + n.columnWidths[u.line] + a.padding),
                            (s = u.y = n.top + a.padding),
                            u.line++),
                          x(r, s, t),
                          (b[e].left = r),
                          (b[e].top = s),
                          w(r, s, t, i),
                          k ? (u.x += o + a.padding) : (u.y += C);
                      });
                    }
                  },
                  handleEvent: function (t) {
                ...
                })),
                {
                  ...
                  beforeUpdate: function (e) {
                    var a = e.options.legend,
                      r = e.legend;
                    a
                      ? ((a = i.configMerge(t.defaults.global.legend, a)),
                        r ? (o.configure(e, r, a), (r.options = a)) : n(e, a))
                      : r && (o.removeBox(e, r), delete e.legend);
                  },
                  ...
                  draw: function () {
                    ...
                    if (a.display) {
                      var s,
                        ...
                        v = e.bottom,
                        y = e.right;
                      (i.fillStyle = o(a.fontColor, r.defaultFontColor)),
                        (i.font = p),
                        e.isHorizontal()
                          ? ((s = g + (y - g) / 2),
                            (l = m + (v - m) / 2),
                ...
                })),
                {
                  ...
                  beforeUpdate: function (o) {
                    var a = o.options.title,
                      r = o.titleBlock;
                    a
                      ? ((a = n.configMerge(t.defaults.global.title, a)),
                        r ? (i.configure(o, r, a), (r.options = a)) : e(o, a))
                      : r &&
                        (t.layoutService.removeBox(o, r), delete o.titleBlock);
                  },
                }
              );
            };
                ...
                i = t.Scale.extend({
                  ...
                  getPixelForValue: function (t, e, n, i) {
                    ...
                    if (
                      (void 0 !== t &&
                        null !== t &&
                        (o = a.isHorizontal() ? t.x : t.y),
                      void 0 !== o || (void 0 !== t && isNaN(e)))
                    ) {
                      var s = a.getLabels();
                      t = o || t;
                      var l = s.indexOf(t);
                    ...
                    if (a.isHorizontal()) {
                      var c = a.width / r,
                        u = c * (e - a.minIndex);
                      return (
                        ((a.options.gridLines.offsetGridLines && i) ||
                          (a.maxIndex === a.minIndex && i)) &&
                          (u += c / 2),
                        a.left + Math.round(u)
                      );
                    }
                    var d = a.height / r,
                      h = d * (e - a.minIndex);
                    return (
                      a.options.gridLines.offsetGridLines && i && (h += d / 2),
                      a.top + Math.round(h)
                    );
                  },
                  getPixelForTick: function (t, e) {
                ...
                i = t.LinearScaleBase.extend({
                  determineDataLimits: function () {
                    ...
                    if (
                      ...
                      e.each(r, function (a, r) {
                        ...
                        void 0 === c[l] &&
                          (c[l] = { positiveValues: [], negativeValues: [] });
                        ...
                        e.each(c, function (t) {
                          var i = t.positiveValues.concat(t.negativeValues),
                            o = e.min(i),
                            a = e.max(i);
                          (n.min = null === n.min ? o : Math.min(n.min, o)),
                            (n.max = null === n.max ? a : Math.max(n.max, a));
                        });
                    } else
                      e.each(r, function (i, a) {
                    ...
                    (n.min = isFinite(n.min) ? n.min : 0),
                      (n.max = isFinite(n.max) ? n.max : 1),
                  ...
                  getPixelForValue: function (t) {
                    ...
                    return n.isHorizontal()
                      ? ((e = n.left + (n.width / a) * (o - i)), Math.round(e))
                      : ((e = n.bottom - (n.height / a) * (o - i)),
                        Math.round(e));
                  },
                  getValueForPixel: function (t) {
                    var e = this,
              ...
              t.LinearScaleBase = t.Scale.extend({
                ...
                buildTicks: function () {
                  ...
                  var r = {
                    ...
                    s = (n.ticks = t.Ticks.generators.linear(r, n));
                  n.handleDirectionalChanges(),
                    (n.max = e.max(s)),
                    (n.min = e.min(s)),
                    o.reverse
                      ? (s.reverse(), (n.start = n.max), (n.end = n.min))
                ...
                i = t.Scale.extend({
                        ...
                        a.isDatasetVisible(r) &&
                          ...
                          e.each(o.data, function (t, e) {
                            ...
                            isNaN(a) ||
                              s.data[e].hidden ||
                              ((o[e] = o[e] || 0),
                              i.relativePoints ? (o[e] = 100) : (o[e] += a));
                          }));
                      }),
                        e.each(d, function (t) {
                          var i = e.min(t),
                          ...
                          (n.min = null === n.min ? i : Math.min(n.min, i)),
                            (n.max = null === n.max ? o : Math.max(n.max, o));
                        });
                    } else
                  ...
                  buildTicks: function () {
                    var n = this,
                      ...
                      r = (n.ticks = t.Ticks.generators.logarithmic(a, n));
                    n.isHorizontal() || r.reverse(),
                      (n.max = e.max(r)),
                      (n.min = e.min(r)),
                      o.reverse
                        ? (r.reverse(), (n.start = n.max), (n.end = n.min))
                        : ((n.start = n.min), (n.end = n.max));
                  },
                  convertTicksToLabels: function () {
                  ...
                  getPixelForValue: function (t) {
                    ...
                    return (
                      a.isHorizontal()
                        ? ((o = e.log10(a.end) - e.log10(r)),
                          0 === s
                            ? (i = a.left)
                            : ((n = a.width),
                              (i =
                                a.left + (n / o) * (e.log10(s) - e.log10(r)))))
                        : ((n = a.height),
                          0 !== r || c.reverse
                            ? 0 === a.end && c.reverse
                              ? ((o = e.log10(a.start) - e.log10(a.minNotZero)),
                                (i =
                                  s === a.end
                                    ? a.top
                                    : s === a.minNotZero
                                    ...
                                    : a.top +
                                      0.02 * n +
                                      ((0.98 * n) / o) *
                                        (e.log10(s) - e.log10(a.minNotZero))))
                              : 0 === s
                              ? (i = c.reverse ? a.top : a.bottom)
                              : ((o = e.log10(a.end) - e.log10(r)),
                                (n = a.height),
                                (i =
                                  a.bottom -
                                  (n / o) * (e.log10(s) - e.log10(r))))
                            : ((o = e.log10(a.end) - e.log10(a.minNotZero)),
                              (i =
                                s === r
                                  ? a.bottom
                                  : s === a.minNotZero
                  ...
                  getValueForPixel: function (t) {
                    var n,
                      i,
                      o = this,
                      a = e.log10(o.end) - e.log10(o.start);
                    return (
                      o.isHorizontal()
                        ? ((i = o.width),
                          (n = o.start * Math.pow(10, ((t - o.left) * a) / i)))
                        : ((i = o.height),
                          (n =
                            Math.pow(10, ((o.bottom - t) * a) / i) / o.start)),
                      n
                    );
                  },
                });
            ...
            e.exports = function (t) {
              ...
              function n(t) {
                var e = t.options.pointLabels,
                  ...
                  o = p.getValueOrDefault(e.fontFamily, f.defaultFontFamily);
                return {
                  size: n,
                  style: i,
                  family: o,
                  font: p.fontString(n, i, o),
                };
              }
              function i(t, e, n) {
                return p.isArray(n)
                  ? {
                      w: p.longestText(t, t.font, n),
              ...
              function a(t) {
                ...
                var h = e(t);
                for (a = 0; a < h; a++) {
                  (s = t.getPointPosition(a, c)),
                    (r = i(t.ctx, l.size, t.pointLabels[a] || "")),
                    (t._pointLabelSizes[a] = r);
                  var f = t.getIndexAngle(a),
                    m = p.toDegrees(f) % 360,
                    g = o(m, s.x, r.w, 0, 180),
                    v = o(m, s.y, r.h, 90, 270);
                  g.start < u.l && ((u.l = g.start), (d.l = f)),
                    g.end > u.r && ((u.r = g.end), (d.r = f)),
                    v.start < u.t && ((u.t = v.start), (d.t = f)),
                    v.end > u.b && ((u.b = v.end), (d.b = f));
                }
                ...
                for (var m = e(t) - 1; m >= 0; m--) {
                  ...
                  if (u.display) {
                    var v = t.getPointPosition(m, d + 5),
                      y = o(u.fontColor, f.defaultFontColor);
                    (i.font = h.font), (i.fillStyle = y);
                    var b = t.getIndexAngle(m),
                      x = p.toDegrees(b);
                    (i.textAlign = s(x)),
                      c(x, t._pointLabelSizes[m], v),
              ...
              function d(t, n, i, o) {
                var a = t.ctx;
                if (
                  ((a.strokeStyle = p.getValueAtIndexOrDefault(n.color, o - 1)),
                  (a.lineWidth = p.getValueAtIndexOrDefault(
                    n.lineWidth,
                    o - 1
                  )),
              ...
              var p = t.helpers,
                ...
                g = t.LinearScaleBase.extend({
                  setDimensions: function () {
                    ...
                    var i = p.min([t.height, t.width]),
                      o = p.getValueOrDefault(n.fontSize, f.defaultFontSize);
                  ...
                  getTickLimit: function () {
                    var t = this.options.ticks,
                      e = p.getValueOrDefault(t.fontSize, f.defaultFontSize);
                    return Math.min(
                      ...
                      p.each(t.ticks, function (s, l) {
                        if (l > 0 || e.reverse) {
                          var u = t.getDistanceFromCenterForValue(
                            ...
                            h = t.yCenter - u;
                          if (
                            (n.display && 0 !== l && d(t, n, u, l), i.display)
                          ) {
                            var p = o(i.fontColor, f.defaultFontColor);
                            if (((a.font = c), i.showLabelBackdrop)) {
                              var m = a.measureText(s).width;
                              (a.fillStyle = i.backdropColor),
                                a.fillRect(
                                  t.xCenter - m / 2 - i.backdropPaddingX,
                                  h - r / 2 - i.backdropPaddingY,
                                  m + 2 * i.backdropPaddingX,
                                  r + 2 * i.backdropPaddingY
                                );
                            }
                            (a.textAlign = "center"),
                              (a.textBaseline = "middle"),
                              (a.fillStyle = p),
                              a.fillText(s, t.xCenter, h);
                          }
                        }
                      }),
          ...
          function (t, e, n) {
            ...
            (i = "function" == typeof i ? i : window.moment),
              (e.exports = function (t) {
                ...
                function n(t, e, n, i) {
                  for (
                    var o, a = Object.keys(s), r = a.length, l = a.indexOf(t);
                    l < r;
                    l++
                  ) {
                    o = a[l];
                ...
                function o(t, e, n, i) {
                  ...
                  if (o.steps)
                    ...
                    for (; r > i && i > 0; ) ++l, (r = Math.ceil(c / (a * l)));
                  return l;
                }
                function a(t, e, n) {
                  var o = [];
                  ...
                  return (
                    "week" === t.unit && r !== !1
                      ? ((n = i(e.min)
                          ...
                          .isoWeekday(r)
                          .valueOf()),
                        (o = i(e.max).startOf("isoWeek").isoWeekday(r)),
                        e.max - o > 0 && o.add(1, "week"),
                        (o = o.valueOf()))
                      : ((n = i(e.min).startOf(t.unit).valueOf()),
                        (o = i(e.max).startOf(t.unit)),
                        e.max - o > 0 && o.add(1, t.unit),
                        (o = o.valueOf())),
                    a(t, e, { min: n, max: o })
                  );
                };
                var c = t.Scale.extend({
                  initialize: function () {
                    if (!i)
                      throw new Error(
                  ...
                  determineDataLimits: function () {
                    ...
                    r.each(s.labels, function (r, s) {
                      ...
                      r.each(s.datasets, function (s, c) {
                        var u = [];
                        "object" == typeof s.data[0] &&
                        null !== s.data[0] &&
                        n.chart.isDatasetVisible(c)
                          ? r.each(s.data, function (r, s) {
                              var l = e(n, n.getRightValue(r));
                              l.isValid() &&
                                (i.round && l.startOf(i.round),
                                (t = l.valueOf()),
                                (o = Math.min(t, o)),
                                (a = Math.max(t, a)),
                                (u[s] = t));
                  ...
                  buildTicks: function () {
                    ...
                    var h = s.getLabelCapacity(i || c),
                      p = l.unit || n(l.minUnit, i || c, a || u, h);
                    ...
                    var i = this,
                      o =
                        i.chart.data.labels && t < i.chart.data.labels.length
                          ...
                          : "",
                      a = i.chart.data.datasets[n].data[t];
                    return (
                      null !== a &&
                        "object" == typeof a &&
                        (o = i.getRightValue(a)),
                      i.options.time.tooltipFormat &&
                        (o = e(i, o).format(i.options.time.tooltipFormat)),
                      o
                    );
                  },
                  tickFormatFunction: function (t, e, n) {
                    var i = t.format(this.displayFormat),
                      ...
                      a = r.getValueOrDefault(o.callback, o.userCallback);
                    return a ? a(i, e, n) : i;
                  },
                  convertTicksToLabels: function () {
                    var t = this;
                  ...
                  getPixelForValue: function (t, n, i) {
                    ...
                    if (
                      (void 0 !== n &&
                        void 0 !== i &&
                        (a = o._parsedData.datasets[i][n]),
                      null === a &&
                        ((t && t.isValid) || (t = e(o, o.getRightValue(t))),
                        t && t.isValid && t.isValid() && (a = t.valueOf())),
                      null !== a)
                    )
                  ...
                  getValueForPixel: function (t) {
                    var e = this,
                      ...
                      o = (t - (e.isHorizontal() ? e.left : e.top)) / n;
                  ...
                  getLabelWidth: function (e) {
                    var n = this,
                      ...
                      s = Math.sin(r.toRadians(i.maxRotation));
                    return (
                      o * a +
                      r.getValueOrDefault(
                        i.fontSize,
...
var WOW = function (t) {
  var e = t || {};
  (this._boxClass = e.boxClass || "wow"),
    (this._animateClass = e.animateClass || "animated"),
    (this._offset = e.offset || 0),
    (this._mobile = void 0 === e.mobile),
    (this._live = void 0 === e.live),
    (this._seoFixEnabled = void 0 === e.seoFixEnabled),
    (this._animationDuration = e.animationDuration || "1s"),
    (this._animationDelay = e.animationDelay || "0s"),
...
(WOW.prototype._initStorageVariables = function () {
  ...
  (WOW.prototype.init = function () {
    (!this._mobile && this._isMobile()) ||
      (this._eachBoxInit(this._prepareBox.bind(this)), this._startWow());
  }),
  ...
  (WOW.prototype._eachBoxInit = function (t) {
    for (
      var e = document.getElementsByClassName(this._boxClass), n = 0;
      n < e.length;
      n++
    )
      !(function (n) {
  ...
  (WOW.prototype._prepareBox = function (t) {
    ...
    (this._animation[e] = {
      animationName:
        t.style.animationName || window.getComputedStyle(t, null).animationName,
    }),
      (t.style.animationName = "none"),
      (t.style.visibility = "hidden");
  }),
  (WOW.prototype._startWow = function () {
    this._live && this._checkForChanges(),
      0 === window.scrollY && this._seoFixEnabled && this._seoFix(),
      this._appearInView(),
      this._scrollHandler();
  }),
  ...
  (WOW.prototype._appear = function (t, e) {
    ...
    t.className.indexOf(this._animateClass) === -1 &&
      (delete this._boxes[e],
      this._onStartAnimation(t, e),
      this._onStopAnimation(t, e),
      this._animate(t, e, this._getAnimationConfig(t)));
  }),
  (WOW.prototype._onStartAnimation = function (t, e) {
    (this._cleanupBoxVisibleListener[e] = this._boxVisible.bind(this, t, e)),
      t.addEventListener("animationstart", this._cleanupBoxVisibleListener[e]),
      t.addEventListener(
        "webkitAnimationStart",
        this._cleanupBoxVisibleListener[e]
      );
  }),
  (WOW.prototype._onStopAnimation = function (t, e) {
    (this._cleanupBoxListener[e] = this._cleanupBox.bind(this, t, e)),
      t.addEventListener("animationend", this._cleanupBoxListener[e]),
      t.addEventListener("webkitAnimationEnd", this._cleanupBoxListener[e]);
  }),
  (WOW.prototype._getAnimationConfig = function (t) {
    return {
      delay: this._getDelay(t),
      duration: this._getDuration(t),
      iterations: this._getIterations(t),
    };
  }),
  ...
  (WOW.prototype._getIterations = function (t) {
    return (
      t.getAttribute("data-wow-iteration") ||
      t.style.animationIterationCount ||
      window.getComputedStyle(t, null).animationIterationCount ||
      1
    );
  }),
  (WOW.prototype._animate = function (t, e, n) {
    (t.style.animationDelay = n.delay),
      (t.style.animationDuration = n.duration),
      (t.style.animationIterationCount = n.iterations),
      (t.style.animationName = this._animation[e].animationName),
      (t.className += " " + this._animateClass);
  }),
  (WOW.prototype._boxVisible = function (t, e) {
    (t.style.visibility = "visible"),
      ...
      delete this._cleanupBoxVisibleListener[e];
  }),
  (WOW.prototype._cleanupBox = function (t, e) {
    (t.style.animationDelay = ""),
      ...
      (t.style.animationIterationCount = ""),
      (t.style.animationName = "none"),
      this._cleanupClass(t),
      t.removeEventListener("animationend", this._cleanupBoxListener[e]),
      t.removeEventListener("webkitAnimationEnd", this._cleanupBoxListener[e]),
      delete this._cleanupBoxListener[e];
  }),
  (WOW.prototype._cleanupClass = function (t) {
    var e = t.className.split(" "),
      n = e.indexOf(this._animateClass);
    n !== -1 && (e.splice(n, 1), (t.className = e.join(" ")));
  }),
  ...
  (WOW.prototype._getElementOffset = function (t) {
    var e = t.getBoundingClientRect(),
      n = document.body,
      i =
        window.pageYOffset || document.documentElement.scrollTop || n.scrollTop,
  ...
  (WOW.prototype.doSync = function (t) {
    if (t.className) {
      t.className.split(" ").indexOf(this._boxClass) !== -1 &&
        this._prepareBox(t);
    }
  });
var OFFSET_TOP = 50,
...
$(window).scroll(function () {
  ...
  (function (t, e) {
      ...
      if (null !== e) {
        ...
        if ((g.registerEvent(t), "touchstart" === t.type && f.delay)) {
          var n = !1,
            ...
            o = function (o) {
              i && (clearTimeout(i), (i = null), f.show(t, e)),
                n || ((n = !0), f.hide(o, e));
            },
            a = function (t) {
          ...
          f.show(t, e),
            p &&
              (e.addEventListener("touchend", f.hide, !1),
              e.addEventListener("touchcancel", f.hide, !1)),
            e.addEventListener("mouseup", f.hide, !1),
            e.addEventListener("mouseleave", f.hide, !1);
      }
    }
    var u = u || {},
      ...
      f = {
        ...
        show: function (t, e, n) {
          ...
          "touches" in t && t.touches.length
            ...
            : ((s = t.pageY - o.top), (l = t.pageX - o.left)),
            (l = l >= 0 ? l : 0),
            (s = s >= 0 ? s : 0);
        ...
        hide: function (t, e) {
          e = e || this;
          for (
            var n = e.getElementsByClassName("waves-rippling"),
              i = 0,
              o = n.length;
            i < o;
            i++
      ...
      g = {
        ...
        allowEvent: function (t) {
          var e = !0;
          return (
            /^(mousedown|mousemove)$/.test(t.type) && g.touches && (e = !1), e
          );
        },
    ...
    return (
      (u.init = function (t) {
        var e = document.body;
        (t = t || {}),
          "duration" in t && (f.duration = t.duration),
          "delay" in t && (f.delay = t.delay),
          p &&
            (e.addEventListener("touchstart", c, !1),
            e.addEventListener("touchcancel", g.registerEvent, !1),
            e.addEventListener("touchend", g.registerEvent, !1)),
          e.addEventListener("mousedown", c, !1);
      }),
      (u.attach = function (t, e) {
        (t = o(t)),
          "[object Array]" === h.call(e) && (e = e.join(" ")),
          (e = e ? " " + e : "");
        for (var n, i, a = 0, r = t.length; a < r; a++)
          (n = t[a]),
            (i = n.tagName.toLowerCase()),
            ["input", "img"].indexOf(i) !== -1 &&
              (m[i](n), (n = n.parentElement)),
            n.className.indexOf("waves-effect") === -1 &&
      ...
      (u.ripple = function (t, e) {
        ...
        if (
          ...
          for (
            var i, r, s, l = {}, c = 0, u = { type: "mousedown", button: 1 };
            c < n;
            c++
          )
            if (
      ...
      (u.calm = function (t) {
        t = o(t);
        for (
          var e = { type: "mouseup", button: 1 }, n = 0, i = t.length;
          n < i;
          n++
        )
          f.hide(e, t[n]);
  ...
  Waves.attach(
    ".navbar-nav a:not(.navbar-brand), .nav-icons li a, .navbar form, .nav-tabs .nav-item",
    ["waves-light"]
  ),
            ...
            i
              ...
              i.find("select.initialized").each(function (e, n) {
                var i = t(n),
                  ...
                  a = i.children("[selected]").val();
                i.val(a), o.val(a);
              });
          }
        }),
        t(".hiddendiv").first().length ||
          (($hiddenDiv = t('<div class="hiddendiv common"></div>')),
  ...
  (function (t) {
    ...
    function o(t, e) {
      ...
      t && n
        ...
        : t || n || (e.removeClass("valid"), e.addClass("invalid"));
    }
  ...
  (function (t) {
    t(["jquery"], function (t) {
      return (function () {
        ...
        function l(e) {
          var i = m();
          if ((v || n(i), e && 0 === t(":focus", e).length)) return void g(e);
        ...
        function f(e) {
          ...
          function r() {
            e.message &&
              (S.append(e.message).addClass(f.messageClass), k.append(S));
          }
          function s() {
            f.closeButton &&
          ...
          function u() {
            (f.timeOut > 0 || f.extendedTimeOut > 0) &&
              ((w = setTimeout(c, f.extendedTimeOut)),
              (I.maxHideTime = parseFloat(f.extendedTimeOut)),
              (I.hideEta = new Date().getTime() + I.maxHideTime));
          }
          function d() {
            clearTimeout(w),
              (I.hideEta = 0),
          ...
          var f = m(),
            y = e.iconClass || f.iconClass;
          if (
            (void 0 !== e.optionsOverride &&
              ((f = t.extend(f, e.optionsOverride)),
              (y = e.optionsOverride.iconClass || y)),
            !(function (t, e) {
            ...
            return (
              ...
              (function () {
                k.hide(),
                  ...
                  f.timeOut > 0 &&
                    ((w = setTimeout(c, f.timeOut)),
                    (I.maxHideTime = parseFloat(f.timeOut)),
                    (I.hideEta = new Date().getTime() + I.maxHideTime),
                    f.progressBar && (I.intervalId = setInterval(h, 10)));
              })(),
              (function () {
                k.hover(d, u),
                  !f.onclick && f.tapToDismiss && k.click(c),
                  f.closeButton &&
                    M &&
                    M.click(function (t) {
                      t.stopPropagation
          ...
          function i() {
            void 0 !== r.data("induration") &&
              ...
              void 0 !== r.data("constrainwidth") &&
                (s.constrain_width = r.data("constrainwidth")),
          ...
          function o(e) {
            ...
            if (
              (!g.is("body") &&
                ...
                (m = g[0].scrollTop),
              a + c.innerWidth() > t(window).width()
                ? (d = "right")
                : a - c.innerWidth() + r.innerWidth() < 0 && (d = "left"),
              u + c.innerHeight() > n)
            )
            ...
            if ("left" === d) (h = s.gutter), (p = r.position().left + h);
            else if ("right" === d) {
              var y = r.position().left + r.outerWidth() - c.outerWidth();
              (h = -s.gutter), (p = y + h);
            }
            c.css({
              position: "absolute",
              top: r.position().top + f + m,
              left: p,
            }),
              c
                .stop(!0, !0)
                ...
                .animate(
                  { opacity: 1 },
                  { queue: !1, duration: s.inDuration, easing: "easeOutSine" }
                );
          }
          function a() {
            (l = !1),
            ...
            r.unbind("click." + r.attr("id")),
              ...
              r.on("mouseleave", function (e) {
                t(e.toElement || e.relatedTarget)
                  ...
                  .is(c) || (c.stop(!0, !0), a(), (u = !1));
              }),
              c.on("mouseleave", function (e) {
                t(e.toElement || e.relatedTarget)
                  .closest(".dropdown-button")
                  .is(r) || (c.stop(!0, !0), a(), (u = !1));
              });
          } else
            r.unbind("click." + r.attr("id")),
              r.bind("click." + r.attr("id"), function (e) {
                l ||
                  (r[0] != e.currentTarget ||
                  r.hasClass("active") ||
                  0 !== t(e.target).closest(".dropdown-content").length
                    ? r.hasClass("active") &&
                      (a(),
                      t(document).unbind(
                        "click." + c.attr("id") + " touchstart." + c.attr("id")
                      ))
...
dropdownSelectors.on({
  ...
  (function (t, e, n, i) {
    ...
    function x(t, e) {
      for (
        var n, o, a = e[0].toUpperCase() + e.slice(1), r = 0;
        r < dt.length;

      ) {
        if (((n = dt[r]), (o = n ? n + a : e) in t)) return o;
        r++;
      }
      return i;
    }
    ...
    function S(t) {
      ...
      return new (e ? e : kt ? V : Ct ? H : wt ? Y : W)(t, T);
    }
    function T(t, e, n) {
    ...
    function M(t, e) {
      ...
      (e.overallVelocityX = c.x),
        ...
        (e.scale = r ? R(r.pointers, i) : 1),
        (e.rotation = r ? F(r.pointers, i) : 0),
    ...
    function B(t, e) {
      ...
      for (o = 0; o < r.length; )
        i[r[o].identifier] && s.push(r[o]),
          e & (It | At) && delete i[r[o].identifier],
          o++;
    ...
    function rt(t, e) {
      return (
        (e = e || {}),
        (e.recognizers = d(e.recognizers, rt.defaults.preset)),
        new st(t, e)
      );
    }
    function st(t, e) {
      (this.options = ut({}, rt.defaults, e || {})),
      ...
      set: function (t) {
        "compute" == t && (t = this.compute()),
          te &&
            ...
            re[t] &&
            (this.manager.element.style[Jt] = t),
    ...
    (Q.prototype = {
      ...
      recognize: function (t) {
        ...
        this.state & (de | he | 32) && (this.state = se),
          (this.state = this.process(e)),
          this.state & (le | ce | ue | he) && this.tryEmit(e);
      },
      process: function (t) {},
      ...
      l(tt, J, {
        ...
        attrTest: function (t) {
          return (
            ...
            (this.state & le || (!(this.state & le) && this.directionTest(t)))
          );
        },
        emit: function (t) {
      ...
      l(et, J, {
        ...
        attrTest: function (t) {
          return (
            ...
            (Math.abs(t.scale - 1) > this.options.threshold || this.state & le)
          );
        },
        emit: function (t) {
          if (1 !== t.scale) {
      ...
      l(it, J, {
        ...
        attrTest: function (t) {
          return (
            this._super.attrTest.call(this, t) &&
            (Math.abs(t.rotation) > this.options.threshold || this.state & le)
          );
        },
      }),
      l(ot, J, {
    ...
    (st.prototype = {
          ...
          for (var a = 0; a < i.length; )
            (n = i[a]),
              2 === e.stopped || (o && n != o && !n.canRecognizeWith(o))
                ? n.reset()
                : n.recognize(t),
              !o && n.state & (le | ce | ue) && (o = e.curRecognizer = n),
              a++;
        }
      },
      get: function (t) {
      ...
      ((void 0 !== t ? t : "undefined" != typeof self ? self : {}).Hammer = rt),
      "function" == typeof define && define.amd
        ? define(function () {
            return rt;
          })
...
!(function (t) {
    ...
    i = (function () {
      function i(o, a) {
        ...
        t("body").append(d),
            ...
            t(window).resize(function () {
              window.innerWidth > n
                ? t("#sidenav-overlay").length
                  ? r.removeMenu(!0)
                  : r.menu_id.css("transform", "translateX(0%)")
                : s === !1 &&
                  ("left" === a.edge
                    ? r.menu_id.css("transform", "translateX(-100%)")
                    : r.menu_id.css("transform", "translateX(100%)"));
            })),
          ...
          c.click(function (e) {
            if ((e.preventDefault(), s === !0)) (s = !1), r.removeMenu();
            else {
              var n = t("body"),
              ...
              n.append(i),
                "left" === r.options.edge
                  ? r.menu_id.velocity(
                      { translateX: [0, -1 * a.menuWidth] },
                      { duration: 300, queue: !1, easing: "easeOutQuad" }
                    )
                  : r.menu_id.velocity(
                      { translateX: [0, a.menuWidth] },
                      { duration: 300, queue: !1, easing: "easeOutQuad" }
                    ),
                i.click(function () {
                  r.removeMenu();
          ...
          d
            ...
            .bind("pan", function (e) {
              if ("touch" == e.gesture.pointerType) {
                ...
                if (
                  ("left" === a.edge &&
                    (n > a.menuWidth ? (n = a.menuWidth) : n < 0 && (n = 0)),
                  "left" === a.edge)
                )
                  n < a.menuWidth / 2
                    ? (s = !1)
                    ...
                    r.menu_id.css(
                      "transform",
                      "translateX(" + (n - a.menuWidth) + "px)"
                    );
                else {
                  n < window.innerWidth - a.menuWidth / 2
                    ? (s = !0)
                    : n >= window.innerWidth - a.menuWidth / 2 && (s = !1);
                  var c = n - a.menuWidth / 2;
                  c < 0 && (c = 0),
                    r.menu_id.css("transform", "translateX(" + c + "px)");
                }
                var u;
                "left" === a.edge
                  ? ((u = n / a.menuWidth),
                  ...
                  : ((u = Math.abs((n - window.innerWidth) / a.menuWidth)),
                    t("#sidenav-overlay").velocity(
                      { opacity: u },
                      { duration: 10, queue: !1, easing: "easeOutQuad" }
                    ));
                  ...
                  "left" === a.edge
                    ? (s && n <= 0.3) || n < -0.5
                      ? (0 != o &&
                        ...
                        d.css({ width: "10px", right: "", left: 0 }))
                      : (!s || n > 0.3) &&
                        (t("body").css({ overflow: "", width: "" }),
                        r.menu_id.velocity(
                          { translateX: [-1 * a.menuWidth - 10, o] },
                    ...
                    ? (r.menu_id.velocity(
                      ...
                      d.css({ width: "50%", right: "", left: 0 }))
                    : (!s || n < -0.3) &&
                      (t("body").css({ overflow: "", width: "" }),
                      r.menu_id.velocity(
                        { translateX: [a.menuWidth + 10, l] },
                        { duration: 200, queue: !1, easing: "easeOutQuad" }
                      ),
                      t("#sidenav-overlay").velocity(
                        { opacity: 0 },
                ...
                "left" === this.options.edge
                  ? this.menu_id.velocity(
                      { translateX: "-100%" },
                      {
                        ...
                        complete: function () {
                          e === !0 &&
                            (n.menu_id.removeAttr("style"),
                            n.menu_id.css("width", n.options.menuWidth));
                        },
                      }
                    )
                  : this.menu_id.velocity(
        ...
        this.each(function () {
          function n(e) {
            (s = r.find("> li > .collapsible-header")),
              ...
              s.not(e).removeClass("active").parent().removeClass("active"),
              s
                .not(e)
                .parent()
          ...
          r.off("click.collapse", ".collapsible-header"),
            s.off("click.collapse"),
            e.accordion || "accordion" === l || void 0 === l
              ? ((s = r.find("> li > .collapsible-header")),
                s.on("click.collapse", function (e) {
                  var i = t(e.target);
                  o(i) && (i = a(i)), i.toggleClass("active"), n(i);
                }),
                n(s.filter(".active").first()))
              : s.each(function () {
  ...
  (function (t, e) {
    ...
    var e = function (t, e) {
        ...
        window.devicePixelRatio > 1 &&
          ...
          o.rotate((-0.5 + e.rotate / 180) * Math.PI);
        ...
        var s = function (t, e, n) {
          ...
          l = function () {
            ...
            for (var i = 24; i > 0; --i)
              i % 6 == 0
                ? ((n = e.scaleLength), (t = 0))
                : ((n = 0.6 * e.scaleLength), (t = e.scaleLength - n)),
        ...
        (this.getCanvas = function () {
            ...
            e.scaleColor || e.trackColor
              ? o.getImageData && o.putImageData
                ? n
                  ...
                  : (u(), (n = o.getImageData(0, 0, e.size * a, e.size * a)))
                : (this.clear(), u())
              : this.clear(),
              (o.lineCap = e.lineCap);
            var i;
          ...
          (this.animate = function (t, n) {
            ...
            var o = function () {
              ...
              this.draw(r),
                e.onStep(t, n, r),
                a >= e.animate.duration ? e.onStop(t, n) : c(o);
            }.bind(this);
            c(o);
          }.bind(this));
      },
    ...
    t(e).each(o),
        ...
        "input" !== e.type) &&
          ((i =
            void 0 === e.pageX || null === e.pageX
              ? e.originalEvent.touches[0].pageX - t(this).offset().left
              : e.pageX - t(this).offset().left),
          i < 0 ? (i = 0) : i > s && (i = s),
          r.addClass("active").css("left", i));
        r.find(".value").html(a.val());
      }),
      ...
      t(document).on("mousemove touchmove", ".range-field", function (i) {
        ...
        if (n) {
          ...
          a =
            void 0 === i.pageX || null === i.pageX
              ? i.originalEvent.touches[0].pageX - t(this).offset().left
              : i.pageX - t(this).offset().left;
  ...
  (function (t) {
    t(document).on("change", '.file-field input[type="file"]', function (e) {
      for (
        var n = t(e.target),
          i = n.closest(".file-field"),
          o = i.find("input.file-path"),
          a = n[0].files,
          r = [],
          s = 0;
        s < a.length;
      ...
      function n(t, e, n) {
        ...
        return (
          ...
          n
            ...
            .eq(e)
            .toggleClass("active"),
          n.find("option").eq(e).prop("selected", a),
          i(t, n),
          a
        );
      }
      ...
      t(this).each(function () {
        ...
        if (!i.hasClass("browser-default")) {
          ...
          var d = t(
            ...
            g = function () {
              ...
              e.find("li")
                .find("span.filtrable")
                .each(function () {
                  "string" == typeof this.outerText &&
                    (this.outerText.toLowerCase().startsWith(n.toLowerCase())
                      ? (t(this).show(), t(this).parent().show())
                      : (t(this).hide(), t(this).parent().hide()));
                });
            },
            v = !!i.attr("searchable");
          v &&
            (function () {
              var e = i.attr("searchable"),
                n = t(
                  '<span class="search-wrap"><input type="text" class="search" placeholder="' +
                    e +
                    '"></span>'
                );
          ...
          var y = function (e, n, i) {
            ...
            "" !== a &&
              ((i = "multiple" === e.attr("multiple") ? "multiple" : i),
              (r = !0));
            var l = n.data("icon"),
              c = n.attr("class");
            if (l) {
                  ...
                  ? d.append(
                      t(
                        '<li class="' +
                          ...
                          '"' +
                          u +
                          '><span class="filtrable"><input type="checkbox"' +
                          o +
                          "/><label></label>" +
                          n.html() +
                          "</span></li>"
                ...
                if (
                  ...
                  a && r
                    ...
                    : (d.find("li").removeClass("active"),
                      ...
                      w.val(t(this).text())),
                    k(d, t(this)),
                    i.find("option").eq(o).prop("selected", c),
                    i.trigger("change"),
                    void 0 !== e && e();
                }
                l.stopPropagation();
          ...
          i.before(w),
            w.before(b),
            w.after(d),
            i.is(":disabled") || w.dropdown({ hover: !1, closeOnClick: !1 }),
            i.attr("tabindex") && t(w[0]).attr("tabindex", i.attr("tabindex")),
            i.addClass("initialized"),
            w.on({
              focus: function () {
                if (
                  (t("ul.select-dropdown").not(d[0]).is(":visible") &&
          ...
          var k = function (e, n) {
            ...
            C = [],
            S = function (e) {
              if (9 == e.which) return void w.trigger("close");
              if (40 == e.which && !d.is(":visible"))
                return void w.trigger("open");
              if (13 != e.which || d.is(":visible")) {
                ...
                40 == e.which &&
                  ((r = d.find("li.selected").length
                    ? d.find("li.selected").next("li:not(.disabled)")[0]
                    : d.find("li:not(.disabled)")[0]),
                  k(d, r)),
                  27 == e.which && w.trigger("close"),
                  38 == e.which &&
                    (r = d.find("li.selected").prev("li:not(.disabled)")[0]) &&
                    k(d, r),
                  setTimeout(function () {
                    C = [];
                  }, 1e3);
  ...
  (function (t) {
    ...
    function e(a, r, l, h) {
      function p() {
        return e._.node(
          ...
          e._.node(
            ...
            e._.node(
              "div",
              e._.node("div", I.component.nodes(k.open), S.box),
              S.wrap
            ),
            S.frame
          ),
      ...
      function f() {
        T.data(r, I)
          .addClass(S.input)
          .val(T.data("value") ? I.get("select", C.format) : a.value),
          C.editable ||
            T.on("focus." + k.id + " click." + k.id, function (t) {
            ...
            "mousedown click": function (e) {
              ...
              n != I.$holder[0] &&
                ...
                "mousedown" != e.type ||
                  ...
                  (e.preventDefault(), I.$holder[0].focus()));
            },
          })
          .on(
            "click",
            ...
            function () {
              var e = t(this),
                ...
                o = s();
              (o = o && (o.type || o.href)),
                (i || (o && !t.contains(I.$root[0], o))) &&
                  I.$holder[0].focus(),
                !i && n.nav
                  ? I.set("highlight", I.component.item.highlight, {
                      nav: n.nav,
                    })
                  : !i && "pick" in n
                  ? (I.set("select", n.pick), C.closeOnSelect && I.close(!0))
                  : n.clear
                  ? (I.clear(), C.closeOnClear && I.close(!0))
                  : n.close && I.close(!0);
            }
          );
      }
      function v() {
        ...
        C.hiddenName === !0
          ? ((e = a.name), (a.name = ""))
          : ((e = [
              "string" == typeof C.hiddenPrefix ? C.hiddenPrefix : "",
              "string" == typeof C.hiddenSuffix ? C.hiddenSuffix : "_submit",
            ]),
            (e = e[0] + a.name + e[1])),
          (I._hidden = t(
            '<input type=hidden name="' +
              e +
              '"' +
              (T.data("value") || a.value
                ? ' value="' + I.get("select", C.formatSubmit) + '"'
                : "") +
              ">"
          )[0]),
          T.on("change." + k.id, function () {
            I._hidden.value = a.value ? I.get("select", C.formatSubmit) : "";
          });
      }
      function y() {
        w && d
          ? I.$holder.find("." + S.frame).one("transitionend", function () {
              I.$holder[0].focus();
            })
          : I.$holder[0].focus();
      }
      function b(t) {
        t.stopPropagation(),
          T.addClass(S.target),
          I.$root.addClass(S.focused),
          I.open();
      }
      function x(t) {
        var e = t.keyCode,
          n = /^(8|46)$/.test(e);
        if (27 == e) return I.close(!0), !1;
        (32 == e || n || (!k.open && I.component.key[e])) &&
          (t.preventDefault(),
          t.stopPropagation(),
          n ? I.clear().close() : I.open());
      }
      if (!a) return e;
      var w = !1,
        ...
        I = (M.prototype = {
          ...
          start: function () {
            return k && k.start
              ...
              : ((k.methods = {}),
                ...
                (k.type = a.type),
                (a.autofocus = a == s()),
                (a.readOnly = !C.editable),
                (a.id = a.id || k.id),
                "text" != a.type && (a.type = "text"),
                (I.component = new l(I, C)),
                (I.$root = t(
                  '<div class="' + S.picker + '" id="' + a.id + '_root" />'
                )),
                m(),
                (I.$holder = t(p()).appendTo(I.$root)),
                g(),
                C.formatSubmit && v(),
                f(),
                C.containerHidden
                  ? t(C.containerHidden).append(I._hidden)
                  : T.after(I._hidden),
                C.container ? t(C.container).append(I.$root) : T.after(I.$root),
                I.on({
                  start: I.component.onStart,
                  render: I.component.onRender,
                  stop: I.component.onStop,
                  open: I.component.onOpen,
                  close: I.component.onClose,
                  set: I.component.onSet,
                }).on({
                  start: C.onStart,
                  render: C.onRender,
                  stop: C.onStop,
          ...
          render: function (e) {
            return (
              e
                ? ((I.$holder = t(p())), g(), I.$root.html(I.$holder))
                : I.$root.find("." + S.box).html(I.component.nodes(k.open)),
              I.trigger("render")
            );
          },
          stop: function () {
            return k.start
              ? (I.close(),
                I._hidden && I._hidden.parentNode.removeChild(I._hidden),
                I.$root.remove(),
                T.removeClass(S.input).removeData(r),
                setTimeout(function () {
                  T.off("." + k.id);
                }, 0),
                (a.type = k.type),
            ...
            return k.open
              ...
              : (T.addClass(S.active),
                ...
                n !== !1 &&
                  ...
                  y(),
                  c
                    .on("click." + k.id + " focusin." + k.id, function (t) {
                      var e = t.target;
                      e != a &&
                        e != document &&
                        3 != t.which &&
                        I.close(e === I.$holder[0]);
                    })
                    .on("keydown." + k.id, function (n) {
                      ...
                      27 == i
                        ? I.close(!0)
                        : a != I.$holder[0] || (!o && 13 != i)
                        ? t.contains(I.$root[0], a) &&
                          13 == i &&
                          (n.preventDefault(), a.click())
                        : (n.preventDefault(),
                          o
                            ? e._.trigger(I.component.key.go, I, [
                                e._.trigger(o),
                              ])
                            : I.$root
                                .find("." + S.highlighted)
                                .hasClass(S.disabled) ||
                              (I.set("select", I.component.item.highlight),
                              C.closeOnSelect && I.close(!0)));
                    })),
                I.trigger("open"));
          },
          close: function (t) {
            return (
              t &&
                (C.editable
                  ? a.focus()
                  : (I.$holder.off("focus.toOpen").focus(),
                    setTimeout(function () {
              ...
              o(a, "expanded", !1),
              setTimeout(function () {
                I.$root.removeClass(S.opened + " " + S.focused),
                  o(I.$root[0], "hidden", !0);
              }, 0),
              k.open
                ? ((k.open = !1),
                  w && u.css("overflow", "").css("padding-right", "-=" + i()),
                  c.off("." + k.id),
                  I.trigger("close"))
                : I
            );
          ...
          set: function (e, n, i) {
            ...
            if (((i = r && t.isPlainObject(n) ? n : i || {}), e)) {
              ...
              for (o in s)
                (a = s[o]),
                  o in I.component.item &&
                    (void 0 === a && (a = null), I.component.set(o, a, i)),
                  ("select" != o && "clear" != o) ||
                    T.val("clear" == o ? "" : I.get(o, C.format)).trigger(
                      "change"
                    );
              I.render();
            }
          ...
          get: function (t, n) {
            ...
            if ("valueSubmit" == t) {
              if (I._hidden) return I._hidden.value;
              t = "value";
            }
            ...
            if (t in I.component.item) {
              if ("string" == typeof n) {
                ...
                return i
                  ? e._.trigger(I.component.formats.toString, I.component, [
                      n,
                      i,
                    ])
                  : "";
    ...
    function o(e, n, i) {
      if (t.isPlainObject(n)) for (var o in n) a(e, o, n[o]);
      else a(e, n, i);
    }
    function a(t, e, n) {
    ...
    return (
      ...
      (e._ = {
        group: function (t) {
          for (
            var n, i = "", o = e._.trigger(t.min, t);
            o <= e._.trigger(t.max, t, [o]);
            o += t.i
          )
            (n = e._.trigger(t.item, t, [o])),
  ...
  (function (t) {
    ...
    function n(t, e) {
      ...
      (n.settings = e),
        ...
        r
          ? n.set("select", r, { format: s, defaultValue: !0 })
    ...
    (n.prototype.set = function (t, e, n) {
      var i = this,
        o = i.item;
      return null === e
        ? ("clear" == t && (t = "select"), (o[t] = e), i)
        : ((o["enable" == t ? "disable" : "flip" == t ? "enable" : t] = i.queue[
            t
          ]
            .split(" ")
            .map(function (o) {
        ...
        return (
          ...
          n == -(1 / 0) || n == 1 / 0
            ...
            ? ((n = new Date(n[0], n[1], n[2])),
              (n = i.isDate(n) ? n : r.create().obj))
            : (n =
                i.isInteger(n) || i.isDate(n)
                  ? r.normalize(new Date(n), o)
                  : r.now(t, n, o)),
          {
      ...
      (n.prototype.createRange = function (t, n) {
        ...
        return (
          i.isInteger(t) || (t = a(t)),
          i.isInteger(n) || (n = a(n)),
          i.isInteger(t) && e.isPlainObject(n)
            ? (t = [n.year, n.month, n.date + t])
            : i.isInteger(n) &&
              e.isPlainObject(t) &&
              (n = [t.year, t.month, t.date + n]),
          { from: a(t), to: a(n) }
        );
      }),
      ...
      (n.prototype.navigate = function (t, n, i) {
        ...
        if (l || c) {
          for (
            c
              ? ((a = n.year), (r = n.month), (s = n.date))
              : ((a = +n[0]), (r = +n[1]), (s = +n[2])),
              i && i.nav && u && u.month !== r && ((a = u.year), (r = u.month)),
              o = new Date(a, r + (i && i.nav ? i.nav : 0), 1),
              a = o.getFullYear(),
              r = o.getMonth();
      ...
      (n.prototype.measure = function (t, e) {
        ...
        return (
          e
            ? "string" == typeof e
              ? (e = n.parse(t, e))
              : i.isInteger(e) && (e = n.now(t, e, { rel: e }))
            : (e = "min" == t ? -(1 / 0) : 1 / 0),
          e
        );
      }),
      ...
      (n.prototype.validate = function (t, n, o) {
        ...
        if (
          ...
          ((!h && c.disabled(n)) ||
            (h && c.disabled(n) && (m || a || r)) ||
            (!h && (n.pick <= p.pick || n.pick >= f.pick)))
        )
          for (
            h && !m && ((!r && d > 0) || (!a && d < 0)) && (d *= -1);
            c.disabled(n) &&
      ...
      (n.prototype.disabled = function (t) {
        var n = this,
          o = n.item.disable.filter(function (o) {
            return i.isInteger(o)
              ? t.day === (n.settings.firstDay ? o : o - 1) % 7
              : e.isArray(o) || i.isDate(o)
              ? t.pick === n.create(o).pick
              : e.isPlainObject(o)
              ? n.withinRange(o, t)
              : void 0;
          });
        return (
          ...
          n.item.enable === -1
            ? !o
            : o || t.pick < n.item.min.pick || t.pick > n.item.max.pick
        );
      }),
      (n.prototype.parse = function (t, e, n) {
        ...
        return e && "string" == typeof e
          ? ((n && n.format) || ((n = n || {}), (n.format = o.settings.format)),
            o.formats.toArray(n.format).map(function (t) {
              var n = o.formats[t],
                r = n ? i.trigger(n, o, [e, a]) : t.replace(/^!/, "").length;
        ...
        return {
          ...
          toString: function (t, e) {
            ...
            return n.formats
              ...
              .map(function (t) {
                return (
                  i.trigger(n.formats[t], n, [0, e]) || t.replace(/^!/, "")
                );
              })
              .join("");
          },
      ...
      (n.prototype.nodes = function (t) {
        var e = this,
          ...
          h = (function (t, e) {
            return (
              n.firstDay && (t.push(t.shift()), e.push(e.shift())),
              i.node(
                "thead",
                i.node(
                  "tr",
            ...
            (n.showWeekdaysFull ? n.weekdaysFull : n.weekdaysShort).slice(0),
          ...
          p = function (t) {
            return i.node(
              ...
              "data-nav=" +
                ...
                ' title="' +
                (t ? n.labelMonthNext : n.labelMonthPrev) +
                '"'
            );
          },
          f = function () {
            ...
            return n.selectMonths
              ? i.node(
                  ...
                  (t ? "" : "disabled") +
                    " " +
                    i.ariaAttr({ controls: e.$node[0].id + "_table" }) +
                    ' title="' +
                    n.labelMonthSelect +
                    '"'
                )
              : i.node("div", o[l.month], n.klass.month);
          },
          m = function () {
            var o = l.year,
            ...
            h +
              i.node(
                ...
                i.group({
                  ...
                  item: function (t) {
                    var o =
                      n.firstDay && 0 === e.create([l.year, l.month, 1]).day
                        ? -7
                        : 0;
                    return [
                      i.group({
                        ...
                        item: function (t) {
                          ...
                          var o = r && r.pick == t.pick,
                            ...
                            p =
                              ...
                              t.pick < u.pick ||
                              t.pick > d.pick,
                            f = i.trigger(e.formats.toString, e, [n.format, t]);
                          return [
                            i.node(
                              "div",
                              t.date,
                              (function (e) {
                                return (
                                  ...
                                  a.pick == t.pick && e.push(n.klass.now),
                                  o && e.push(n.klass.selected),
                                  h && e.push(n.klass.highlighted),
          ...
          i.node(
            ...
            i.node(
              ...
              "type=button data-pick=" +
                ...
                " " +
                i.ariaAttr({ controls: e.$node[0].id })
            ) +
              i.node(
                "button",
                n.clear,
  ...
  (function () {
    ...
    function i(i, r) {
          ...
          c && d.append(P.canvas),
            ...
            s.off(p).on(p, function (t) {
              ...
              var e = /^touch/.test(t.type),
                ...
                i = (e ? t.originalEvent.touches[0] : t).pageY - a;
            ...
            s.off(f).on(f, function (t) {
              ...
              var n = /^touch/.test(t.type),
                ...
                c = (n ? t.originalEvent.changedTouches[0] : t).pageY - a;
              (e || m) && i === l && c === u && P.setHand(i, c),
                "hours" === P.currentView
                  ? P.toggleView("minutes", k / 2)
                  : r.autoclose &&
      ...
      r.darktheme && u.addClass("darktheme"),
        a(
          ...
          .click(a.proxy(this.done, this))
          .appendTo(this.footer),
        this.spanHours.click(a.proxy(this.toggleView, this, "hours")),
        this.spanMinutes.click(a.proxy(this.toggleView, this, "minutes")),
        I.on("focus.clockpicker click.clockpicker", a.proxy(this.show, this));
      var _,
        E,
        O,
        L,
        F = a('<div class="clockpicker-tick"></div>');
      if (r.twelvehour)
        for (_ = 1; _ < 13; _ += 1)
          (E = F.clone()),
            (O = (_ / 6) * Math.PI),
            ...
            E.css("font-size", "140%"),
            E.css({
              left: v + Math.sin(O) * L - x,
              top: v - Math.cos(O) * L - x,
            }),
            E.html(0 === _ ? "00" : _),
            g.append(E),
            E.on(h, l);
      ...
      for (_ = 0; _ < 60; _ += 5)
        (E = F.clone()),
          (O = (_ / 30) * Math.PI),
          E.css({
            left: v + Math.sin(O) * y - x,
            top: v - Math.cos(O) * y - x,
          }),
          E.css("font-size", "140%"),
          E.html(e(_)),
          S.append(E),
      ...
      if (
        ...
        V.setAttribute("class", "clockpicker-svg"),
          ...
          V.setAttribute("height", w);
        var z = t("g");
        z.setAttribute("transform", "translate(" + v + "," + v + ")");
        var N = t("circle");
        N.setAttribute("class", "clockpicker-canvas-bearing"),
          N.setAttribute("cx", 0),
          N.setAttribute("cy", 0),
          N.setAttribute("r", 2);
        var H = t("line");
    ...
    (i.DEFAULTS = {
        ...
        if (!this.isShown) {
          ...
          (this.hours = +i[0] || 0),
            ...
            s.on(
              ...
              function (t) {
                var e = a(t.target);
                0 === e.closest(n.popover.find(".picker__wrap")).length &&
                  0 === e.closest(n.input).length &&
                  n.hide();
              }
            ),
      ...
      (i.prototype.toggleView = function (t, e) {
        var n = !1;
        "minutes" === t &&
          "visible" === a(this.hoursView).css("visibility") &&
          (o(this.options.beforeHourSelect), (n = !0));
        var i = "hours" === t,
        ...
        (this.currentView = t),
          ...
          n && o(this.options.afterHourSelect);
      }),
      (i.prototype.resetClock = function (t) {
        var e = this.currentView,
          ...
          u = this;
        c && t
          ? (u.canvas.addClass("clockpicker-canvas-out"),
            setTimeout(function () {
      ...
      (i.prototype.setHand = function (t, n, i, o) {
        ...
        if (
          ...
          (this[this.currentView] = r),
          this[l ? "spanHours" : "spanMinutes"].html(e(r)),
          !c)
        )
          return void this[l ? "hoursView" : "minutesView"]
        ...
        this.hand.setAttribute("x2", g),
          ...
          this.fg.setAttribute("cx", w),
          this.fg.setAttribute("cy", k);
      }),
  ...
  (function (t, e) {
    ...
    return function (t, e, n, i) {
      var o = {
        ...
        detectFeatures: function () {
          ...
          if (
            ...
            (l = parseFloat(l)),
              l >= 1 &&
                (4.4 > l && (i.isOldAndroid = !0), (i.androidVersion = l)),
      ...
      var s,
        ...
        Mt = function (t) {
          ...
          if (e) {
            ...
            n.shift();
            for (var i = 0; i < e.length; i++) e[i].apply(a, n);
          }
        },
        It = function () {
        ...
        Pt = function (t, e, n, i, o) {
          (!wt || (o && o !== a.currItem)) &&
            ...
            (t[A] = y + e + "px, " + n + "px" + b + " scale(" + i + ")");
        },
        Dt = function (t) {
          et &&
            (t &&
              (g > a.currItem.fitRatio
                ? wt || (ln(a.currItem, !1, !0), (wt = !0))
                : wt && (ln(a.currItem), (wt = !1))),
            Pt(et, ht.x, ht.y, g));
        },
        _t = function (t) {
          t.container &&
        ...
        Ot = function (t, e) {
          if (!r.loop && e) {
            var n = u + (gt.x * ft - t) / gt.x,
              i = Math.round(t - fe.x);
            ((0 > n && i > 0) || (n >= Qe() - 1 && 0 > i)) &&
              (t = fe.x + i * r.mainScrollEndFriction);
          }
          (fe.x = t), Et(t, d);
        },
        Lt = function (t, e) {
          var n = me[t] - mt[t];
          return dt[t] + ut[t] + n - n * (e / v);
        },
        Ft = function (t, e) {
        ...
        Vt = function () {
          Wt &&
            (o.unbind(document, "mousemove", Vt),
        ...
        zt = function () {
          o.bind(document, "keydown", a),
            ...
            r.mouseUsed || o.bind(document, "mousemove", Vt),
        ...
        jt = function (t, e, n, i) {
          return i === a.currItem.initialZoomLevel
            ? ((n[t] = a.currItem.initialPosition[t]), !0)
            : ((n[t] = Lt(t, i)),
              n[t] > e.min[t]
                ? ((n[t] = e.min[t]), !0)
        ...
        $t = function () {
          if (A) {
            return (
              (y = "translate" + (W.perspective && !D ? "3d(" : "(")),
        ...
        Jt = function () {
          for (var t in Qt) Qt.hasOwnProperty(t) && Gt(t);
        },
        te = function (t, e, n, i, o, a, r) {
          var s,
            l = It();
          Kt(t);
          var c = function () {
            if (Qt[t]) {
              if ((s = It() - l) >= i) return Gt(t), a(n), void (r && r());
              a((n - e) * o(s / i) + e), (Qt[t].raf = _(c));
            }
          };
          c();
        },
        ee = {
          ...
          init: function () {
            if (!s && !l) {
              ...
              Mt("firstUpdate"),
                (u = u || r.index || 0),
                (isNaN(u) || 0 > u || u >= Qe()) && (u = 0),
                (a.currItem = Ue(u)),
                (W.isOldIOSPhone || W.isOldAndroid) && (yt = !1),
                ...
                void 0 === R && (Mt("initialLayout"), (R = L = o.getScrollY()));
              var c = "pswp--open ";
              for (
          ...
          close: function () {
            s &&
              ...
              Mt("close"),
              Nt(),
              Ge(a.currItem, null, !0, a.destroy));
          },
          destroy: function () {
            Mt("destroy"),
              je && clearTimeout(je),
            ...
            if (0 !== vt) {
              ...
              if (!(t && 2 > n)) {
                (a.currItem = Ue(u)),
                  (wt = !1),
                  Mt("beforeChange", vt),
                  n >= 3 && ((h += vt + (vt > 0 ? -3 : 3)), (n = 3));
                for (var i = 0; n > i; i++)
                  vt > 0
                    ? ((e = k.shift()),
                      (k[2] = e),
                      h++,
                      Et((h + 2) * gt.x, e.el.style),
                      a.setContent(e, u - n + i + 1 + 1))
                    : ((e = k.pop()),
                      k.unshift(e),
                      h--,
                      Et(h * gt.x, e.el.style),
                      a.setContent(e, u + n - i - 1 - 1));
                if (et && 1 === Math.abs(vt)) {
                  var o = Ue(C);
                  o.initialZoomLevel !== g && (on(o, pt), ln(o), _t(o));
                }
          ...
          updateSize: function (e) {
            if (!yt && r.modal) {
              var n = o.getScrollY();
              if (
                (R !== n && ((t.style.top = n + "px"), (R = n)),
                !e && xt.x === window.innerWidth && xt.y === window.innerHeight)
              )
                return;
              (xt.x = window.innerWidth),
                (xt.y = window.innerHeight),
                (t.style.height = xt.y + "px");
            }
            if (
              ((pt.x = a.scrollWrap.clientWidth),
              (pt.y = a.scrollWrap.clientHeight),
              Ut(),
              (gt.x = pt.x + Math.round(pt.x * r.spacing)),
              (gt.y = pt.y),
              Ot(gt.x * ft),
              Mt("beforeResize"),
              void 0 !== h)
              ...
              for (var i, s, l, c = 0; 3 > c; c++)
                (i = k[c]),
                  Et((c + h) * gt.x, i.el.style),
                  (l = u + c - 1),
                  r.loop && Qe() > 2 && (l = Ct(l)),
                  (s = Ue(l)),
                  s && (w || s.needsUpdate || !s.bounds)
                    ? (a.cleanSlide(s),
                      a.setContent(i, l),
                      1 === c && ((a.currItem = s), a.updateCurrZoomItem(!0)),
                      (s.needsUpdate = !1))
                    : -1 === i.index && l >= 0 && a.setContent(i, l),
                  s && s.container && (on(s, pt), ln(s), _t(s));
              w = !1;
            }
            (v = g = a.currItem.initialZoomLevel),
              (tt = a.currItem.bounds),
              tt && ((ht.x = tt.center.x), (ht.y = tt.center.y), Dt(!0)),
              Mt("resize");
          },
          zoomTo: function (t, e, n, i, a) {
            e &&
              ((v = g),
              (me.x = Math.abs(e.x) - ht.x),
              (me.y = Math.abs(e.y) - ht.y),
              Ft(dt, ht));
            var r = Ht(t, !1),
              s = {};
            jt("x", r, s, t), jt("y", r, s, t);
            var l = g,
              c = { x: ht.x, y: ht.y };
            Rt(s);
            var u = function (e) {
              1 === e
                ? ((g = t), (ht.x = s.x), (ht.y = s.y))
                : ((g = (t - l) * e + l),
                  (ht.x = (s.x - c.x) * e + c.x),
                  (ht.y = (s.y - c.y) * e + c.y)),
                a && a(e),
        ...
        be = function (t, e) {
          return (
            (ue.x = Math.abs(t.x - e.x)),
            (ue.y = Math.abs(t.y - e.y)),
            Math.sqrt(ue.x * ue.x + ue.y * ue.y)
          );
        },
        xe = function () {
          U && (E(U), (U = null));
        ...
        Te = function (t, e) {
          return (
            (Se.prevent = !Ce(t.target, r.isClickableElement)),
            Mt("preventDragEvent", t, e, Se),
            Se.prevent
          );
        },
        Me = function (t, e) {
        ...
        Ae = function (t, e, n) {
          if (t - z > 50) {
            ...
            (i.x = e), (i.y = n), ce.push(i), (z = t);
          }
        },
        Pe = function () {
          var t = ht.y - a.currItem.initialPosition.y;
        ...
        Oe = function (t) {
          ...
          return (
            P
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Ee[0] = Me(t.touches[0], De)),
                t.touches.length > 1 && (Ee[1] = Me(t.touches[1], _e)))
              : ((De.x = t.pageX),
                (De.y = t.pageY),
                (De.id = ""),
                (Ee[0] = De)),
              ...
              ? "h" !== it ||
                ...
                (c
                  ? (l > tt.min[t] &&
                      ...
                      (i = tt.min[t] - dt[t])),
                    (0 >= i || 0 > d) && Qe() > 1
                      ? ((s = u), 0 > d && u > le.x && (s = le.x))
                      : tt.min.x !== tt.max.x && (o = l))
                  : (l < tt.max[t] &&
                      ((n = r.panEndFriction),
                      l - tt.max[t],
                      (i = dt[t] - tt.max[t])),
                    (0 >= i || d > 0) && Qe() > 1
                      ? ((s = u), d > 0 && u < le.x && (s = le.x))
                      : tt.min.x !== tt.max.x && (o = l)))
              : (s = u),
            "x" !== t)
              ? void (
                  nt ||
                  Q ||
                  (g > a.currItem.fitRatio && (ht[t] += e[t] * n))
                )
              : (void 0 !== s && (Ot(s, !0), (Q = s !== le.x)),
                tt.min.x !== tt.max.x &&
                  (void 0 !== o ? (ht.x = o) : Q || (ht.x += e.x * n)),
                void 0 !== s)
          );
        },
        Fe = function (t) {
            ...
            if (!Y || "mousedown" !== t.type) {
              ...
              (Z = null),
                ...
                !G &&
                  ...
                  Ft(ie, n[1]),
                  Ie(ne, ie, ge),
                  (me.x = Math.abs(ge.x) - ht.x),
                  (me.y = Math.abs(ge.y) - ht.y),
                  (K = J = be(ne, ie)));
            }
          }
        },
        Re = function (t) {
          ...
          if (j) {
            ...
            if (it || q || G) Z = i;
              ...
              var a = Math.abs(i[0].x - ae.x) - Math.abs(i[0].y - ae.y);
          ...
          if (Z) {
            ...
            if (0 !== t)
              if (
                ...
                if (
                  ((ae.x = ne.x), (ae.y = ne.y), !oe.x && !oe.y && ve(Z[1], ie))
                )
                  return;
                Ft(ie, Z[1]), X || ((X = !0), Mt("zoomGestureStarted"));
                var e = be(ne, ie),
                  n = Be(e);
                n >
                  a.currItem.initialZoomLevel +
                    a.currItem.initialZoomLevel / 15 && (st = !0);
                var i = 1,
                  o = Bt(),
                  s = Yt();
                if (o > n)
                ...
                if (
                  (ot &&
                    ((ot = !1),
                    Math.abs(oe.x) >= 10 && (oe.x -= Z[0].x - re.x),
                    Math.abs(oe.y) >= 10 && (oe.y -= Z[0].y - re.y)),
                  (ae.x = ne.x),
                  (ae.y = ne.y),
                  0 === oe.x && 0 === oe.y)
                )
                  return;
                if ("v" === it && r.closeOnVerticalDrag && !ke()) {
                  (ut.y += oe.y), (ht.y += oe.y);
                  var u = Pe();
                  return (B = !0), Mt("onVerticalDrag", u), At(u), void Dt();
                }
                Ae(It(), ne.x, ne.y), (q = !0), (tt = a.currItem.bounds);
                var d = Le("x", oe);
                d || (Le("y", oe), Rt(ht), Dt());
              }
          }
        ...
        Ve = function (t) {
          ...
          Mt("pointerUp"), Te(t, !1) && t.preventDefault();
          var e;
          if (P) {
            var n = o.arraySearch(se, t.pointerId, "id");
            if (n > -1)
              if (((e = se.splice(n, 1)[0]), navigator.pointerEnabled))
          ...
          var s,
            l = Oe(t),
            c = l.length;
          if (("mouseup" === t.type && (c = 0), 2 === c)) return (Z = null), !0;
          1 === c && Ft(re, l[0]),
            0 !== c ||
              it ||
              nt ||
          ...
          if (
            ...
            if ((Jt(), N || (N = ze()), N.calculateSwipeSpeed("x"), B)) {
              var d = Pe();
              if (d < r.verticalDragRange) a.close();
                ...
                te("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (t) {
                  (ht.y = (a.currItem.initialPosition.y - h) * t + h),
                    At((1 - f) * t + f),
                    Dt();
                }),
                  Mt("onVerticalDrag", 1);
              ...
              if (!nt)
                return "swipe" !== s
                  ? void Ye()
                  : void (!Q && g > a.currItem.fitRatio && Ne(N));
            }
        },
        ze = function () {
          var t,
            ...
            n = {
              ...
              calculateSwipeSpeed: function (i) {
                ce.length > 1
                  ? ((t = It() - z + 50), (e = ce[ce.length - 2][i]))
                  : ((t = It() - V), (e = re[i])),
                  (n.lastFlickOffset[i] = ae[i] - e),
              ...
              calculateOverBoundsAnimOffset: function (t, e) {
                n.backAnimStarted[t] ||
                  (ht[t] > tt.min[t]
                    ? (n.backAnimDestination[t] = tt.min[t])
                    : ht[t] < tt.max[t] &&
                      (n.backAnimDestination[t] = tt.max[t]),
              ...
              panAnimLoop: function () {
                return Qt.zoomPan &&
                  ((Qt.zoomPan.raf = _(n.panAnimLoop)),
                  (n.now = It()),
          ...
          return (
            ...
            Math.abs(t.lastFlickSpeed.y) <= 0.05
              ? ((t.speedDecelerationRatioAbs.x =
                ...
                !0)
              : (Kt("zoomPan"), (t.lastNow = It()), void t.panAnimLoop())
          );
        },
        He = function (t, e) {
          var n;
          ...
          if ("swipe" === t) {
            ...
            s > 30 && (l || e.lastFlickOffset.x > 20)
              ? (i = -1)
              : -30 > s && (l || e.lastFlickOffset.x < -20) && (i = 1);
          }
          var c;
          i &&
            ((u += i),
            0 > u
              ? ((u = r.loop ? Qe() - 1 : 0), (c = !0))
              : u >= Qe() && ((u = r.loop ? 0 : Qe() - 1), (c = !0)),
            (!c || r.loop) && ((vt += i), (ft -= i), (n = !0)));
          var d,
            h = gt.x * ft,
            p = Math.abs(h - fe.x);
          return (
            n || h > fe.x == e.lastFlickSpeed.x > 0
              ? ((d =
            ...
            te("mainScroll", fe.x, h, d, o.easing.cubic.out, Ot, function () {
              Jt(),
                (nt = !1),
                (de = -1),
                (n || de !== u) && a.updateCurrItem(),
        ...
        Ye = function () {
          ...
          return at && !H && !st && e > g
            ...
            : (at &&
              ...
              a.zoomTo(t, 0, 200, o.easing.cubic.out, i),
              !0);
        };
      kt("Gestures", {
        publicMethods: {
      ...
      var je,
                ...
                function () {
                  if ((Mt("initialZoom" + (i ? "Out" : "In")), i)) {
                    var a = l.w / e.w,
                      ...
                      p = function (e) {
                        1 === e
                          ? ((g = a), (ht.x = l.x), (ht.y = l.y - R))
                          : ((g = (a - c) * e + c),
                            (ht.x = (l.x - r.x) * e + r.x),
                            (ht.y = (l.y - R - r.y) * e + r.y)),
                          Dt(),
                          s ? (t.style.opacity = 1 - e) : At(u - e * u);
                      };
                    n
                      ? te("initialZoom", 0, 1, d, o.easing.cubic.out, p, h)
                      : (p(1), (je = setTimeout(h, d + 20)));
                  } else
                    (g = e.initialZoomLevel),
                      Ft(ht, e.initialPosition),
                      Dt(),
                      At(1),
                      s ? (t.style.opacity = 1) : At(1),
                      (je = setTimeout(h, d + 20));
                },
                i ? 25 : 90
              ));
          })();
        ...
        nn = function (t, e, n) {
          var i = t.bounds;
          (i.center.x = Math.round((Ke.x - e) / 2)),
            (i.center.y = Math.round((Ke.y - n) / 2) + t.vGap.top),
            (i.max.x = e > Ke.x ? Math.round(Ke.x - e) : i.center.x),
            (i.max.y =
              n > Ke.y ? Math.round(Ke.y - n) + t.vGap.top : i.center.y),
            (i.min.x = e > Ke.x ? 0 : i.center.x),
            (i.min.y = n > Ke.y ? t.vGap.top : i.center.y);
        },
        on = function (t, e, n) {
        ...
        an = function (t, e, n, i, o, r) {
          e.loadError ||
            (i &&
              ((e.imageAppended = !0),
              ln(e, i, e === a.currItem && wt),
              n.appendChild(i),
              r &&
                setTimeout(function () {
                  e &&
            ...
            for (var t, e = 0; e < Je.length; e++)
              (t = Je[e]),
                t.holder.index === t.index &&
                  an(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
            Je = [];
          }
        };
      kt("Controller", {
        publicMethods: {
            ...
            o.extend(r, tn, !0),
              ...
              Tt("beforeChange", function (t) {
                var e,
                  ...
                  o = Math.min(n[0], Qe()),
                  s = Math.min(n[1], Qe());
                for (e = 1; (i ? s : o) >= e; e++) a.lazyLoadItem(u + e);
                for (e = 1; (i ? o : s) >= e; e++) a.lazyLoadItem(u - e);
              }),
              Tt("initialLayout", function () {
                a.currItem.initialLayout =
                  r.getThumbBoundsFn && r.getThumbBoundsFn(u);
              }),
              Tt("mainScrollAnimComplete", cn),
              Tt("initialZoomInEnd", cn),
              Tt("destroy", function () {
          ...
          setContent: function (t, e) {
            ...
            Mt("gettingData", e, l), (t.index = e), (t.item = l);
            ...
            Xe || e !== u ? _t(l) : ((et = c.style), Ge(l, i || l.img)),
              (t.el.innerHTML = ""),
              t.el.appendChild(c);
          },
      ...
      kt("Tap", {
        publicMethods: {
          initTap: function () {
            Tt("firstTouchStart", a.onTapStart),
              Tt("touchRelease", a.onTapRelease),
              Tt("destroy", function () {
                (dn = {}), (un = null);
              });
          },
          ...
          onTapRelease: function (t, e) {
            if (e && !q && !$ && !Zt) {
              var n = e;
              if (un && (clearTimeout(un), (un = null), ye(n, dn)))
                return void Mt("doubleTap", n);
              if ("mouse" === e.type) return void hn(t, e, "mouse");
              if (
        ...
        publicMethods: {
          ...
          setupDesktopZoom: function (e) {
            ...
            var i,
              r = function () {
                a.mouseZoomedIn &&
                  (o.removeClass(t, "pswp--zoomed-in"), (a.mouseZoomedIn = !1)),
                  1 > g
          ...
          toggleDesktopZoom: function (e) {
            ...
            var n = r.getDoubleTapZoom(!0, a.currItem),
              i = g === n;
            (a.mouseZoomedIn = !i),
              a.zoomTo(i ? a.currItem.initialZoomLevel : n, e, 333),
      ...
      var fn,
        ...
        Dn = function () {
          if ((gn && clearTimeout(gn), Zt || j))
            return void (gn = setTimeout(Dn, 500));
          vn ? clearTimeout(mn) : (vn = !0);
          var t = u + 1,
            e = Ue(u);
          e.hasOwnProperty("pid") && (t = e.pid);
          var n = xn + "&gid=" + r.galleryUID + "&pid=" + t;
          wn || (-1 === Sn.hash.indexOf(n) && (Cn = !0));
          var i = Sn.href.split("#")[0] + "#" + n;
          Tn
            ? "#" + n !== window.location.hash &&
              history[wn ? "replaceState" : "pushState"]("", document.title, i)
            : wn
            ? Sn.replace(i)
            : (Sn.hash = n),
            (wn = !0),
      ...
      kt("History", {
        publicMethods: {
          initHistory: function () {
            if ((o.extend(r, Mn, !0), r.history)) {
              (Sn = window.location),
                ...
                xn.indexOf("gid=") > -1 &&
                  ((xn = xn.split("&gid=")[0]), (xn = xn.split("?gid=")[0])),
                Tt("afterChange", a.updateURL),
                Tt("unbindEvents", function () {
          ...
          onHashChange: function () {
            return In() === xn
              ? ((kn = !0), void a.close())
              : void (vn || ((yn = !0), a.goTo(Pn().pid), (yn = !1)));
          },
          updateURL: function () {
    ...
    return function (t, e) {
        ...
        H = function (t) {
          ...
          if (I()) {
            ...
            if (g.captionEl && "auto" === r.bottom)
              if (
                (a ||
                  ((a = e.createEl("pswp__caption pswp__caption--fake")),
                  a.appendChild(e.createEl("pswp__caption__center")),
                  i.insertBefore(a, o),
      ...
      (w.init = function () {
        e.extend(t.options, T, !0),
          ...
          d("destroy", function () {
            g.captionEl &&
              (a && i.removeChild(a), e.removeClass(o, "pswp__caption--empty")),
          ...
          C && t.currItem
            ? (w.updateIndexIndicator(),
              g.captionEl &&
                ...
                A(o, "caption--empty", !t.currItem.title)),
              (k = !0))
            : (k = !1),
            S || _(),
            P();
        ...
        (w.onGlobalTap = function (n) {
          ...
          if (!v)
            if (n.detail && "mouse" === n.detail.pointerType) {
              ...
              g.tapToClose && (e.hasClass(i, "pswp__img") || L(i)))
            )
              return void t.close();
        }),
        (w.onMouseOver = function (t) {
          (t = t || window.event),
            A(i, "ui--over-close", L(t.target || t.srcElement));
        }),
...
var initPhotoSwipeFromDOM = function (t) {
  for (
    var e = function (t) {
        for (
          var e, n, i, o, a = t.childNodes, r = a.length, s = [], l = 0;
          l < r;
          l++
        )
          (e = a[l]),
      ...
      o = function (t, n, i, o) {
        ...
        isNaN(r.index) ||
          ...
          (a = new PhotoSwipe(l, PhotoSwipeUI_Default, s, r)),
          a.init());
      },
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
      ...
      return this.each(function () {
        function e() {
          var e = p.scrollTop(),
            s = h,
            f = n.parent().width();
          if ((d.width(f), a && "string" == typeof h)) {
            s = t(h).offset().top - r - l;
          }
          if (u < e) {
            if (
              (i.stickyClass && n.addClass(i.stickyClass),
              n.after(d).css({ position: "fixed", top: l, width: f }),
              o && n.css({ zIndex: c }),
              a && s < e)
            ) {
              var m = s - e + l;
        ...
        var n = t(this),
          ...
          p = t(window);
        p.innerHeight() > r &&
          (p.bind("scroll", e), p.bind("load", e), p.bind("resize", e));
      });
    };
  })(jQuery),
  (function t(e, n, i) {
      ...
      4: [
        function (t, e, n) {
          ...
          (o.prototype.eventElement = function (t) {
            ...
            return (
              void 0 === e && ((e = new i(t)), this.eventElements.push(e)), e
            );
          }),
        ...
        function (t, e, n) {
          ...
          (n.extend = function (t, e) {
            ...
            (n.isEditable = function (t) {
              return (
                a.matches(t, "input,[contenteditable]") ||
                a.matches(t, "select,[contenteditable]") ||
                a.matches(t, "textarea,[contenteditable]") ||
                a.matches(t, "button,[contenteditable]")
              );
            }),
            ...
            (n.outerWidth = function (t) {
              return (
                r(a.css(t, "width")) +
                r(a.css(t, "paddingLeft")) +
                r(a.css(t, "paddingRight")) +
                r(a.css(t, "borderLeftWidth")) +
                r(a.css(t, "borderRightWidth"))
              );
            }),
            (n.startScrolling = i(o.add)),
            (n.stopScrolling = i(o.remove)),
            (n.env = {
              isWebKit:
          ...
          function i(t, e) {
            ...
            e.event.bind(e.scrollbarY, "click", i),
              e.event.bind(e.scrollbarYRail, "click", function (i) {
                ...
                r(t, "top", t.scrollTop + s * e.containerHeight),
                  a(t),
                  i.stopPropagation();
              }),
              ...
              e.event.bind(e.scrollbarXRail, "click", function (i) {
                ...
                r(t, "left", t.scrollLeft + s * e.containerWidth),
                  a(t),
                  i.stopPropagation();
              });
          }
        ...
        function (t, e, n) {
          ...
          function i(t, e) {
            ...
            e.event.bind(e.scrollbarX, "mousedown", function (n) {
              (o = n.pageX),
                (i = a.toInt(r.css(e.scrollbarX, "left")) * e.railXRatio),
          ...
          function o(t, e) {
            ...
            e.event.bind(e.scrollbarY, "mousedown", function (n) {
              (o = n.pageY),
                (i = a.toInt(r.css(e.scrollbarY, "top")) * e.railYRatio),
          ...
          function i(t, e) {
            function n(n, i) {
              ...
              if (0 === n) {
                ...
                if (
                  (0 === o && i > 0) ||
                  (o >= e.contentHeight - e.containerHeight && i < 0)
                )
            ...
            e.event.bind(e.ownerDocument, "keydown", function (c) {
              if (
                ...
                var u =
                  a.matches(e.scrollbarX, ":focus") ||
                  a.matches(e.scrollbarY, ":focus");
                if (i || u) {
              ...
              o(u, d) ||
                ...
                e.settings.useBothWheelAxes
                  ? e.scrollbarYActive && !e.scrollbarXActive
                    ? (d
                        ? r(t, "top", t.scrollTop - d * e.settings.wheelSpeed)
                        : r(t, "top", t.scrollTop + u * e.settings.wheelSpeed),
                      (l = !0))
                    : e.scrollbarXActive &&
                      !e.scrollbarYActive &&
                      (u
                        ? r(t, "left", t.scrollLeft + u * e.settings.wheelSpeed)
                        : r(
                            t,
                            "left",
              ...
              e.event.bind(window, "mousemove", function (e) {
                if (d) {
                  ...
                  n.x < a.left + 3
                    ...
                    : (u.left = 0),
                    n.y < a.top + 3
                      ? (a.top + 3 - n.y < 5 ? (u.top = -5) : (u.top = -20),
                        o.startScrolling(t, "y"))
                      : n.y > a.bottom - 3
                      ? (n.y - a.bottom + 3 < 5 ? (u.top = 5) : (u.top = 20),
                        o.startScrolling(t, "y"))
                      : (u.top = 0),
        ...
        function (t, e, n) {
          ...
          function i(t, e, n, i) {
            function o(n, i) {
              ...
              if (s > r) {
                if (
                  (i < 0 && o === e.contentHeight - e.containerHeight) ||
                  (i > 0 && 0 === o)
                )
            ...
            function f(t) {
              if (
                (!w && e.settings.swipePropagation && p(t), !x && w && h(t))
              ) {
                var n = d(t),
                ...
                var s = new Date().getTime(),
                  c = s - v;
                c > 0 && ((y.x = a / c), (y.y = r / c), (v = s)),
                  o(a, r) && (t.stopPropagation(), t.preventDefault());
              }
            }
            function m() {
              !x &&
                ...
                e.settings.swipeEasing &&
                  (clearInterval(b),
                  (b = setInterval(function () {
                    return a.get(t) && (y.x || y.y)
                      ? Math.abs(y.x) < 0.01 && Math.abs(y.y) < 0.01
        ...
        function (t, e, n) {
          ...
          e.exports = function (t, e, n) {
            ...
            "top" === e &&
              ...
              "top" === e &&
                n !== a.lastTop &&
                ((t.scrollTop = a.lastTop = n),
                t.dispatchEvent(o("ps-scroll-y"))),
              "left" === e &&
                n !== a.lastLeft &&
                ((t.scrollLeft = a.lastLeft = n),
  ...
  (function (t) {
    var e = !1,
      n = { data: [], placeholder: "", secondaryPlaceholder: "" };
    t(document).ready(function () {
      ...
      (t.fn.material_chip = function (i) {
        ...
        return (
          ...
          "data" === i
            ...
            : (this.$el.data("options", t.extend({}, n, i)),
              (this.init = function () {
                var e = 0;
                o.$el.each(function () {
                  var n = t(this);
                  if (!n.data("initialized")) {
                    ...
                    (!i.data || !i.data instanceof Array) && (i.data = []),
                      n.data("chips", i.data),
                      n.data("index", e),
                      n.data("initialized", !0),
                      n.hasClass(o.SELS.CHIPS) || n.addClass("chips"),
                      o.chips(n),
                      e++;
                  }
                });
              ...
              (this.handleEvents = function () {
                ...
                o.$document.on("click", e.CHIPS, function (n) {
                      ...
                      if (a.length) {
                        ...
                        if (l) {
                          ...
                          i + 1 < s
                            ...
                            : (i !== s && i + 1 !== s) || (h = s - 1),
                            h < 0 && (h = null),
                            null !== h && o.selectChip(d, h, r),
                            s || r.find("input").focus();
                        } else if (c) {
                          if ((i = a.index() - 1) < 0) return;
                          t(e.CHIP).removeClass("selected"),
                  ...
                  o.$document.on(
                    ...
                    e.CHIPS + " " + e.INPUT,
                    function (n) {
                      t(n.target).closest(e.CHIPS).addClass("focus"),
                        t(e.CHIP).removeClass("selected");
                    }
                  ),
                  o.$document.on(
                  ...
                  o.$document.on(
                    ...
                    function (n) {
                      ...
                      if (13 === n.which)
                        return (
                          n.preventDefault(),
                          o.addChip(r, { tag: i.val() }, a),
                          void i.val("")
                        );
                      var l = 8 === n.keyCode || 37 === n.keyCode,
                        c = "" === i.val();
                      return l && c && s
                        ? (o.selectChip(r, s - 1, a), void i.blur())
                        : void 0;
                    }
                  ),
                  o.$document.on(
              ...
              (this.addChip = function (e, n, i) {
                if (o.isValid(i, n)) {
                  var a = (i.data("options"), o.renderChip(n));
                  i.data("chips").push(n),
                    t(a).insertBefore(i.find("input")),
                    i.trigger("chip.add", n),
                    o.setPlaceholder(i);
                }
              }),
              ...
              (this.selectChip = function (t, e, n) {
                ...
                i &&
                  ...
                  (i.addClass("selected"),
                  n.trigger("chip.select", n.data("chips")[e]));
              }),
              (this.getChipsElement = function (t, e) {
                return e.eq(t);
              }),
              this.init(),
              void (e || (this.handleEvents(), (e = !0))))
        );
      });
  })(jQuery),
  (function (t) {
    ...
    function e(t) {
      ...
      for (
        ...
        --n > -1 && void 0 === s.style[e[n] + t];

      );
      return n >= 0;
    }
    function n() {
      (a = t.innerWidth || document.documentElement.clientWidth),
    ...
    function o(e) {
      t.requestAnimationFrame(function () {
        ...
        for (var t = 0, i = g.length; t < i; t++)
          "scroll" !== e.type && (g[t].coverImage(), g[t].clipContainer()),
            g[t].onScroll();
      });
    }
    Date.now ||
      ...
      t.requestAnimationFrame ||
        (function () {
          for (
            var e = ["webkit", "moz"], n = 0;
            n < e.length && !t.requestAnimationFrame;
            ++n
          ) {
            var i = e[n];
            (t.requestAnimationFrame = t[i + "RequestAnimationFrame"]),
              (t.cancelAnimationFrame =
                ...
                t[i + "CancelRequestAnimationFrame"]);
          }
          if (
      ...
      v = (function () {
        function t(t, n) {
          ...
          if (
            ...
            !(!l || (d && o.options.noAndroid) || (h && o.options.noIos)))
          ) {
    ...
    (v.prototype.css = function (e, n) {
      if ("string" == typeof n)
        return t.getComputedStyle
          ? t.getComputedStyle(e).getPropertyValue(n)
          : e.style[n];
      n.transform &&
        (c && (n.transform += " translateZ(0)"),
        (n.WebkitTransform =
          n.MozTransform =
          n.msTransform =
          n.OTransform =
      ...
      (v.prototype.init = function () {
        ...
        for (
          ...
          var r =
            e.css(a, "-webkit-transform") ||
            e.css(a, "-moz-transform") ||
            e.css(a, "transform");
          r &&
            "none" !== r &&
            ((o = 1),
        ...
        (o ||
          ...
          e.image.width && e.image.height
            ? t()
            : e.getImageSize(e.image.src, function (n, i) {
        ...
        if (t.image.width && t.image.height) {
          ...
          c &&
            ...
            c
              ? ((p = o + (n - d) / 2), (f = (r - h) / 2))
              : ((p = (n - d) / 2), (f = (i - h) / 2)),
            "absolute" === t.image.position && (p -= o),
            (t.parallaxScrollDistance = u),
            t.css(t.image.$item, {
              width: d + "px",
              height: h + "px",
              marginLeft: p + "px",
        ...
        if (e.image.width && e.image.height) {
          ...
          if (
            (e.options.elementInViewport &&
              (l = e.options.elementInViewport.getBoundingClientRect()),
            (e.isElementInViewport =
              l.bottom >= 0 && l.right >= 0 && l.top <= r && l.left <= a),
            ...
            if (
              ...
              ("opacity" !== e.options.type &&
                ...
                ((s.transform = ""), (s.opacity = g)),
              "scale" === e.options.type || "scale-opacity" === e.options.type)
            ) {
              var v = 1;
              e.options.speed < 0
                ? (v -= e.options.speed * g)
                : (v += e.options.speed * (1 - g)),
                (s.transform = "scale(" + v + ")");
            }
            if (
      ...
      for (a; a < o; a++)
        if (
          ("object" == typeof n || void 0 === n
            ? t[a].jarallax || (t[a].jarallax = new v(t[a], n))
            : t[a].jarallax && (e = t[a].jarallax[n].apply(t[a].jarallax, i)),
          void 0 !== e)
        )
          return e;
      return t;
  ...
  (function (t) {
    ...
    var o = (function () {
      function t(t, i) {
        ...
        (o.url = t),
          ...
          (o.options = e({}, o.options_default, i)),
          (o.videoID = o.parseURL(t)),
          o.videoID && ((o.ID = n++), o.loadAPI(), o.init());
      }
      var n = 0;
      return t;
    })();
    (o.prototype.parseURL = function (t) {
        ...
        if (this.userEventsList && this.userEventsList[t])
          if (e)
            for (var n = 0; n < this.userEventsList[t].length; n++)
              this.userEventsList[t][n] === e &&
                (this.userEventsList[t][n] = !1);
      ...
      (o.prototype.fire = function (t) {
        ...
        if (this.userEventsList && void 0 !== this.userEventsList[t])
          for (var n in this.userEventsList[t])
            this.userEventsList[t][n] &&
              this.userEventsList[t][n].apply(this, e);
      }),
      (o.prototype.play = function (t) {
        ...
        e.player &&
          ...
          "local" === e.type &&
            (void 0 !== t && (e.player.currentTime = t), e.player.play()));
      }),
      ...
      (o.prototype.getImageURL = function (t) {
        ...
        if ("youtube" === e.type) {
          ...
          (o.onload = function () {
            ...
            (o.src =
              "https://img.youtube.com/vi/" + e.videoID + "/" + n[i] + ".jpg");
        }
        if ("vimeo" === e.type) {
      ...
      (o.prototype.getIframe = function (e) {
        var n = this;
        if (n.$iframe) return void e(n.$iframe);
        n.onAPIready(function () {
          var o;
          if (
            (n.$iframe ||
              ((o = document.createElement("div")), (o.style.display = "none")),
            "youtube" === n.type)
          ) {
            (n.playerOptions = {}),
            ...
            n.playerOptions.events = {
              ...
              onStateChange: function (t) {
                n.options.loop &&
                  ...
                  n.play(n.options.startTime),
                  a ||
                    t.data !== YT.PlayerState.PLAYING ||
                    ((a = 1), n.fire("started", t)),
                  ...
                  n.options.endTime &&
                    (t.data === YT.PlayerState.PLAYING
                      ? (r = setInterval(function () {
                          n.options.endTime &&
                            n.player.getCurrentTime() >= n.options.endTime &&
                            (n.options.loop
                              ? n.play(n.options.startTime)
                              : n.pause());
                        }, 150))
            ...
            if (s) {
              ...
              l.setAttribute("id", n.playerID),
                o.appendChild(l),
                document.body.appendChild(o);
            }
            (n.player =
              n.player || new t.YT.Player(n.playerID, n.playerOptions)),
              s &&
                ((n.$iframe = document.getElementById(n.playerID)),
                (n.videoWidth =
                  parseInt(n.$iframe.getAttribute("width"), 10) || 1280),
                (n.videoHeight =
                  parseInt(n.$iframe.getAttribute("height"), 10) || 720));
          }
          if ("vimeo" === n.type) {
            (n.playerOptions = ""),
              ...
              n.options.controls ||
                (n.playerOptions += "&badge=0&byline=0&portrait=0&title=0"),
              (n.playerOptions +=
              ...
              n.player.getVideoWidth().then(function (t) {
                n.videoWidth = t || 1280;
              }),
            ...
            n.player.on("timeupdate", function (t) {
              c || n.fire("started", t),
                ...
                n.options.endTime &&
                  n.options.endTime &&
                  t.seconds >= n.options.endTime &&
                  (n.options.loop ? n.play(n.options.startTime) : n.pause());
            }),
          ...
          if ("local" === n.type) {
            if (!n.$iframe) {
              (n.$iframe = document.createElement("video")),
                n.options.mute && (n.$iframe.muted = !0),
                n.options.loop && (n.$iframe.loop = !0),
                n.$iframe.setAttribute("id", n.playerID),
                o.appendChild(n.$iframe),
                document.body.appendChild(o);
            ...
            i(n.player, "playing", function (t) {
              ...
              i(n.player, "timeupdate", function () {
                n.options.endTime &&
                  n.options.endTime &&
                  this.currentTime >= n.options.endTime &&
                  (n.options.loop ? n.play(n.options.startTime) : n.pause());
              }),
              ...
              i(n.player, "loadedmetadata", function () {
                (n.videoWidth = this.videoWidth || 1280),
                  (n.videoHeight = this.videoHeight || 720),
                  n.fire("ready"),
                  n.options.autoplay && n.play(n.options.startTime);
              });
          }
    ...
    o.prototype.loadAPI = function () {
      ...
      if (!a || !r) {
        ...
        if (
          ("youtube" !== e.type ||
            a ||
            ((a = 1), (n = "//www.youtube.com/iframe_api")),
          "vimeo" !== e.type ||
            r ||
            ((r = 1), (n = "//player.vimeo.com/api/player.js")),
          n)
        ) {
    ...
    (o.prototype.onAPIready = function (e) {
      ...
      if (
        ("youtube" === n.type &&
          (("undefined" != typeof YT && 0 !== YT.loaded) || s
        ...
        if ("undefined" != typeof Vimeo || l)
          ...
          var i = setInterval(function () {
            "undefined" != typeof Vimeo &&
              (clearInterval(i), u.resolve("done"), e());
          }, 20);
        }
      "local" === n.type && e();
    }),
    ...
    if ("undefined" != typeof jarallax) {
      ...
      t.prototype.initImg = function () {
        ...
        if (
          ...
          var n = new VideoWorker(t.options.videoSrc, {
            ...
            (n.isValid() &&
              ...
              n.on("started", function () {
                (t.image.$default_item = t.image.$item),
                  ...
                  (t.image.width = t.options.imgWidth =
    ...
    return (
      ...
      this.each(function () {
        ...
        e.on("keyup", function (t) {
          ...
          13 == t.which && (i.children(":first").trigger("click"), i.empty()),
            0 == o.length
